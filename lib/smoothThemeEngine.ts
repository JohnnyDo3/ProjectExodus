...
const TIME_KEYFRAMES: TimeKeyframe[] = [
  ...
  // PRE-DUSK (5pm - 6pm) - Warm golden afternoon fading
  {
    hour: 17.5,
    label: 'Pre-Dusk',
    colors: {
  ...
  // DUSK (6pm - 7pm) - Warm peach/coral sunset beginning
  {
    hour: 18,
    label: 'Early Dusk',
    colors: {
  ...
  // GOLDEN HOUR (6:30pm) - Rich warm coral
  {
    hour: 18.5,
    label: 'Golden Hour',
    colors: {
  ...
  // SUNSET (7pm) - Deep coral/rose
  {
    hour: 19,
    label: 'Sunset Beginning',
    colors: {
      background: '#ffe8d8',
      foreground: EARTH_900,
      primary: '#d04840',
  ...
  // SUNSET PEAK (7:30pm) - Rich rose/magenta hints
  {
    hour: 19.5,
    label: 'Sunset Peak',
    colors: {
  ...
  // LATE SUNSET (8pm) - Transitional dusky rose - CRITICAL BRIDGE
  {
    hour: 20,
    label: 'Late Sunset',
    colors: {
      ...
      accentForeground: WHITE,
      muted: '#c8b8b0',
      mutedForeground: EARTH_800,
      card: '#e0d0c8',
      cardForeground: EARTH_900,
      border: '#b8a090',
    }
  },
  // TWILIGHT (8:20pm) - Darker bridge - smooth transition to dark
  {
    hour: 20.3,
    label: 'Twilight',
    colors: {
      ...
      accentForeground: WHITE,
      muted: '#685850',
      mutedForeground: '#c8c0b8',
      card: '#6a5850',
      cardForeground: '#f0e8e0',
      border: '#585048',
    }
  },
  // EARLY EVENING (8:40pm) - Dark warm brown established
  {
    hour: 20.7,
    label: 'Early Evening',
    colors: {
  ...
  // EVENING (9pm) - Full dark warm theme
  {
    hour: 21,
    label: 'Evening',
    colors: {
