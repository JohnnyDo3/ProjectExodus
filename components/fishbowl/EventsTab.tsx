...
export default function EventsTab() {
  ...
  return (
    <div>
      ...
      <section className="relative py-12 overflow-hidden rounded-2xl bg-gradient-to-br from-[color-mix(in_srgb,var(--secondary)_15%,var(--background))] via-[color-mix(in_srgb,var(--primary)_10%,var(--background))] to-[color-mix(in_srgb,var(--accent)_15%,var(--background))]">
        {/* Decorative circles */}
        ...
        <div className="relative px-4 sm:px-6">
          <div className="text-center">
            ...
            <h2 className="text-3xl sm:text-4xl font-black mb-4 text-[var(--foreground)]">
              Where Paths Converge
            </h2>
            <p className="text-base font-medium text-theme-muted max-w-xl mx-auto mb-8 italic">
