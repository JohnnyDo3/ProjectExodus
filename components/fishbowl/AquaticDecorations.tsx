...
const OCEAN_LAYOUT: LayeredDecoConfig = {
  background: {
    kelps: [
      ...
      { x: 520, height: 55, variant: 'bushy', color: '#1B5E20', delay: 0.3 },
      { x: 550, height: 60, variant: 'wide', color: '#388E3C', delay: 0.8 },
      { x: 580, height: 50, variant: 'thin', color: '#43A047', delay: 1.4 },
...
const SHIPWRECK_LAYOUT: LayeredDecoConfig = {
  ...
  background: {
    kelps: [
      ...
      { x: 30, height: 50, variant: 'bushy', color: '#33691E', delay: 0.4 },
      { x: 55, height: 45, variant: 'thin', color: '#558B2F', delay: 0.9 },
      ...
      { x: 700, height: 55, variant: 'bushy', color: '#2E7D32', delay: 1.5 },
      { x: 730, height: 50, variant: 'wide', color: '#558B2F', delay: 0.3 },
      { x: 760, height: 45, variant: 'thin', color: '#33691E', delay: 1.8 },
    ],
  },
  midground: {
    structures: [
...
const MINIMAL_LAYOUT: LayeredDecoConfig = {
  background: {
    kelps: [
      ...
      { x: 580, height: 60, variant: 'bushy', color: '#2E7D32', delay: 0.4 },
      { x: 610, height: 50, variant: 'wide', color: '#43A047', delay: 0.9 },
      { x: 640, height: 55, variant: 'thin', color: '#388E3C', delay: 1.2 },
      { x: 700, height: 60, variant: 'bushy', color: '#4CAF50', delay: 0.6 },
...
const CASTLE_LAYOUT: LayeredDecoConfig = {
  ...
  background: {
    kelps: [
      ...
      { x: 640, height: 50, variant: 'thin', color: '#33691E', delay: 0.3 },
      { x: 670, height: 55, variant: 'bushy', color: '#2E7D32', delay: 0.8 },
      { x: 710, height: 50, variant: 'wide', color: '#1B5E20', delay: 1.5 },
...
const PYRAMID_LAYOUT: LayeredDecoConfig = {
  ...
  background: {
    kelps: [
      ...
      { x: 660, height: 55, variant: 'bushy', color: '#2E7D32', delay: 0.3 },
      { x: 690, height: 50, variant: 'wide', color: '#388E3C', delay: 0.6 },
      { x: 720, height: 60, variant: 'thin', color: '#558B2F', delay: 1.2 },
      { x: 750, height: 50, variant: 'bushy', color: '#1B5E20', delay: 0.8 },
      { x: 780, height: 45, variant: 'wide', color: '#2E7D32', delay: 1.5 },
      { x: 795, height: 50, variant: 'thin', color: '#388E3C', delay: 1.8 },
    ],
  },
  midground: {
    structures: [
...
const ATLANTIS_LAYOUT: LayeredDecoConfig = {
  ...
  background: {
    kelps: [
      ...
      { x: 110, height: 48, variant: 'wide', color: '#004D40', delay: 0.6 },
      { x: 680, height: 60, variant: 'bushy', color: '#004D40', delay: 0.3 },
      { x: 710, height: 55, variant: 'wide', color: '#00695C', delay: 0.8 },
      { x: 740, height: 50, variant: 'thin', color: '#00897B', delay: 1.5 },
