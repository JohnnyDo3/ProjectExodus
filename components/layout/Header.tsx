            ...
            >
              ...
              {sageContext?.isNapping && !sageContext?.isAnimating && (
                <>
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 pointer-events-none z-[200]">
                    {/* Arrow pointing up */}
                    <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-4 h-4 rotate-45 bg-[var(--card)] border-l-2 border-t-2 border-theme-primary" />
                    {/* Tooltip body */}
                    <div className="relative px-4 py-2.5 bg-[var(--card)] border-2 border-theme-primary rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
