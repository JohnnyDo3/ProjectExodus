              ...
              if (item.name === 'Community') {
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute top-full left-0 mt-2 w-64 rounded-xl overflow-hidden z-[201] transition-all duration-200 origin-top ${
                        communityMenuOpen
                    ...
                    >
                      <div className="bg-[var(--card)]/95 backdrop-blur-xl border-2 border-theme-primary shadow-2xl rounded-xl overflow-hidden">
                        ...
                        {/* Navigation links - simple text list */}
                        <div className="p-2">
                          {communityMenuItems.map((menuItem) => {
                            ...
                            return isLocked ? (
                              ...
                              <Link
                                key={menuItem.label}
                                href={menuItem.href}
                                className="block px-3 py-2 rounded-lg text-sm font-medium text-[var(--foreground)] hover:bg-[var(--muted)]/50 hover:text-[var(--primary)] transition-colors"
                        ...
                        {topUsers.length > 0 && (
                          <>
                            ...
                            <div className="p-2">
                              <div className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-[var(--muted-foreground)] uppercase tracking-wide">
