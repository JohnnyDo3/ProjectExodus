                        ...
                        <div className="px-5 py-4">
                          {learnMenuItems.map((menuItem) => {
                            ...
                            return isLocked ? (
                              <div
                                key={menuItem.label}
                                className="flex items-center justify-center gap-3 px-5 py-3 rounded-lg text-[var(--muted-foreground)] opacity-70 cursor-not-allowed whitespace-nowrap"
                              ...
                              <Link
                                key={menuItem.label}
                                href={menuItem.href}
                                className="flex items-center justify-center gap-3 px-5 py-3 rounded-lg text-sm font-medium text-[var(--foreground)] hover:bg-[var(--muted)] hover:text-emerald-600 transition-colors whitespace-nowrap"
