...
const SLIDES: BillboardSlide[] = [
  {
    ...
    description:
      'Arizona State University\'s Klaus Lackner developed passive mechanical trees using ion-exchange resin sorbents that capture CO₂ directly from ambient air — no fans needed. Each "tree" column can absorb up to 1 ton of CO₂ per day. Carbon Collect Ltd is commercializing the technology with MechanicalTree™ farms planned in the US, with the first pilot deployed at ASU\'s Tempe campus.',
    stat: '1,000×',
    statLabel: 'faster than real trees',
    source: 'Arizona State University / Carbon Collect',
    sourceUrl: 'https://carboncollect.com',
  ...
  },
  {
    ...
    description:
      'Climeworks\' Mammoth plant in Hellisheiði, Iceland is the world\'s largest direct air capture facility. It uses modular CO₂ collector containers powered by geothermal energy. Captured CO₂ is dissolved in water and injected underground via Carbfix, where it mineralizes into basalt rock within 2 years — permanent removal. Mammoth has a nameplate capacity of 36,000 tons CO₂/year across 72 collector containers.',
    stat: '36,000',
    statLabel: 'tons CO₂ removed/year',
    source: 'Climeworks AG',
    sourceUrl: 'https://climeworks.com',
