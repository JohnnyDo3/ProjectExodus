...
const SLIDES: BillboardSlide[] = [
  ...
  },
  {
    ...
    subtitle: 'Mortar-free perlite block construction',
    description:
      'System 3E is a patented Polish construction technology using interlocking perlite blocks (90-99% volcanic mineral) that click together — no mortar, glue, or water. A 100m² house\'s walls go up in 24 hours, 75% faster than traditional methods. Single-layer walls achieve U-value 0.198 W/m²K with REI-240+ fire rating. CO₂ emissions reduced 54% vs conventional, 80% less waste, 100% recyclable. Deployed in 100+ projects across Poland, Spain, Sweden, Netherlands, and the UK.',
    stat: '24hr',
    statLabel: 'walls for a 100m² house',
    source: 'System 3E',
    sourceUrl: 'https://www.system3e.com/product',
  ...
  },
  {
    ...
    description:
      'Hempitecture\'s HempWool (92% hemp fiber) is the first US-manufactured hemp batt insulation, rated R-3.69/inch — matching fiberglass but carbon-negative. ASTM E84 testing scored flame spread 0, smoke developed 0 (best possible). Zero mold growth, naturally repels rodents and termites. Installed in 1,500+ projects, sequestering 1.2 million lbs of CO₂ total. Backed by an $8.4M DOE grant for a Tennessee processing plant and Saint-Gobain partnership. 200% sales growth in 2024.',
    stat: '1.62',
    statLabel: 'tons CO₂ absorbed per ton',
    source: 'Hempitecture Inc.',
    sourceUrl: 'https://www.hempitecture.com/hempwool/',
