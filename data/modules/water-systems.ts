...
export const desalination: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how to make ocean water drinkable!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how salt is removed from seawater.', [LearningLevel.HIGH_SCHOOL]: 'Explore reverse osmosis and thermal desalination technologies.', [LearningLevel.UNDERGRADUATE]: 'Analyze desalination plant design, energy requirements, and economics.', [LearningLevel.GRADUATE]: 'Examine brine disposal, renewable-powered desal, and environmental impacts.', [LearningLevel.PHD]: 'Research next-generation membranes, energy recovery, and hybrid systems.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'desal-1', title: 'Salt to Fresh', content: { [LearningLevel.ELEMENTARY]: '<h2>Freshening the Ocean!</h2><p>Special machines can remove salt from ocean water so we can drink it!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How Desal Works</h2><p>Push seawater through special filters (RO) or boil and collect steam (thermal).</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Technologies</h2><p>RO: 3-4 kWh/m³. Thermal: MED, MSF for high-salinity. Energy is main cost.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Plant Design</h2><p>Intake, pretreatment, RO trains, energy recovery devices, post-treatment.</p>', [LearningLevel.GRADUATE]: '<h2>Sustainability</h2><p>Brine discharge impacts. Solar/wind powered desal. Co-location with power plants.</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>Graphene oxide membranes, capacitive deionization, solar still advances.</p>' } }],
  ...
  game: { id: 'desal-game', title: 'Desal Engineer', type: 'simulation', description: 'Run a desalination plant', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const wastewaterTreatment: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn what happens to water after you flush!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how dirty water gets cleaned at treatment plants.', [LearningLevel.HIGH_SCHOOL]: 'Explore primary, secondary, and tertiary treatment processes.', [LearningLevel.UNDERGRADUATE]: 'Analyze activated sludge, nutrient removal, and plant design.', [LearningLevel.GRADUATE]: 'Examine resource recovery, energy-neutral treatment, and advanced processes.', [LearningLevel.PHD]: 'Research anammox, mainstream deammonification, and circular water systems.' },
  topic: 'water-systems',
  ...
  lessons: [{ id: 'ww-1', title: 'Cleaning Used Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Water\'s Second Life!</h2><p>Water from toilets and sinks goes to a plant where it gets super clean!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Treatment Steps</h2><p>Screens remove big stuff, settling removes solids, bacteria eat organic matter, disinfection kills germs.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Treatment Levels</h2><p>Primary: physical. Secondary: biological (activated sludge). Tertiary: advanced (filtration, nutrient removal).</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Process Design</h2><p>BOD/COD removal, nitrification/denitrification, P removal, sludge handling.</p>', [LearningLevel.GRADUATE]: '<h2>Resource Recovery</h2><p>Biogas from anaerobic digestion, struvite recovery, water reuse.</p>', [LearningLevel.PHD]: '<h2>Advanced Biology</h2><p>Anammox for N removal, granular sludge, membrane bioreactors.</p>' } }],
  ...
  game: { id: 'ww-game', title: 'Plant Operator', type: 'simulation', description: 'Run a treatment plant', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const watershedProtection: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how to protect the areas that give us clean water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover what watersheds are and why they matter.', [LearningLevel.HIGH_SCHOOL]: 'Explore watershed management practices and land use impacts.', [LearningLevel.UNDERGRADUATE]: 'Analyze watershed modeling, BMPs, and source water protection.', [LearningLevel.GRADUATE]: 'Examine payment for ecosystem services and integrated watershed management.', [LearningLevel.PHD]: 'Research ecohydrology, watershed restoration, and climate adaptation.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'ws-1', title: 'Water\'s Home', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Neighborhoods!</h2><p>A watershed is like a big bowl that catches rain and sends it to streams!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Watershed Basics</h2><p>All land drains to a common point. Ridges define boundaries. What happens upstream affects downstream.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Protection Strategies</h2><p>Riparian buffers, forest conservation, erosion control, limiting development.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Watershed Planning</h2><p>Delineation, land use analysis, pollutant loading models, TMDL development.</p>', [LearningLevel.GRADUATE]: '<h2>Ecosystem Services</h2><p>Valuing water quality, PES programs, conservation easements.</p>', [LearningLevel.PHD]: '<h2>Research Areas</h2><p>Paired watershed studies, restoration ecology, climate-watershed interactions.</p>' } }],
  ...
  game: { id: 'ws-game', title: 'Watershed Guardian', type: 'simulation', description: 'Protect your watershed', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterQualityTesting: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how scientists test if water is clean!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover the tests that show if water is safe.', [LearningLevel.HIGH_SCHOOL]: 'Explore physical, chemical, and biological water quality parameters.', [LearningLevel.UNDERGRADUATE]: 'Analyze sampling protocols, analytical methods, and QA/QC.', [LearningLevel.GRADUATE]: 'Examine real-time monitoring, sensor networks, and data management.', [LearningLevel.PHD]: 'Research emerging contaminant detection, biosensors, and predictive monitoring.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'test-1', title: 'Testing Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Is It Clean?</h2><p>Scientists use special tests to check if water is safe for drinking and swimming!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Common Tests</h2><p>pH, temperature, dissolved oxygen, turbidity, bacteria (E. coli). Each tells something different.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Parameters</h2><p>Physical: temp, turbidity. Chemical: pH, DO, nutrients, metals. Biological: bacteria, algae.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Analytical Methods</h2><p>Spectroscopy, chromatography, electrochemical sensors. Proper sampling and chain of custody.</p>', [LearningLevel.GRADUATE]: '<h2>Monitoring Systems</h2><p>Continuous sensors, telemetry, event detection, data validation.</p>', [LearningLevel.PHD]: '<h2>Advanced Detection</h2><p>Trace contaminant analysis, bioassays, machine learning for anomaly detection.</p>' } }],
  ...
  game: { id: 'test-game', title: 'Water Detective', type: 'puzzle', description: 'Diagnose water quality issues', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterStorageTanks: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about tanks that hold water for when we need it!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how water is stored safely for homes and communities.', [LearningLevel.HIGH_SCHOOL]: 'Explore tank types, sizing, and water quality in storage.', [LearningLevel.UNDERGRADUATE]: 'Analyze storage system hydraulics, materials, and design codes.', [LearningLevel.GRADUATE]: 'Examine distribution system optimization, water age, and resilience.', [LearningLevel.PHD]: 'Research smart storage, water quality modeling, and system dynamics.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'store-1', title: 'Holding Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Banks!</h2><p>Big tanks store water like a piggy bank saves money - for when you need it!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Storage Types</h2><p>Water towers (pressure), ground tanks, underground cisterns. Material: concrete, steel, plastic.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Design Considerations</h2><p>Volume for demand + fire flow + emergency. Keep water moving to prevent stagnation.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Hydraulics</h2><p>Elevated vs pumped storage. Pressure zones, turnover rates, disinfectant residual.</p>', [LearningLevel.GRADUATE]: '<h2>Optimization</h2><p>Water age management, variable speed pumping, energy cost minimization.</p>', [LearningLevel.PHD]: '<h2>Smart Systems</h2><p>Real-time optimization, water quality sensors, predictive control.</p>' } }],
  ...
  game: { id: 'store-game', title: 'Storage Manager', type: 'simulation', description: 'Manage water storage levels', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const fogCollection: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how special nets catch water from fog and clouds!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how coastal and mountain communities harvest water from fog.', [LearningLevel.HIGH_SCHOOL]: 'Explore fog harvesting technology, site selection, and yield optimization.', [LearningLevel.UNDERGRADUATE]: 'Analyze fog collector design, mesh materials, and meteorological factors.', [LearningLevel.GRADUATE]: 'Examine fog water quality, community projects, and climate variability impacts.', [LearningLevel.PHD]: 'Research biomimetic fog collection, advanced materials, and atmospheric water generation.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'fog-1', title: 'Catching Clouds', content: { [LearningLevel.ELEMENTARY]: '<h2>Clouds on the Ground!</h2><p>When fog touches special nets, water droplets stick and drip down into containers!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How Fog Nets Work</h2><p>Mesh panels face the wind. Fog droplets collect on threads and drip to troughs. Can yield 200-1000 L/day per collector.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Fog Harvesting Science</h2><p>Best locations: coastal mountains, 400-1200m elevation, persistent advection fog. Raschel mesh common. Collection efficiency 1-10%.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Collector Design</h2><p>Mesh parameters: shade coefficient, filament diameter, weave pattern. Wind speed and liquid water content determine yield.</p>', [LearningLevel.GRADUATE]: '<h2>Project Development</h2><p>Site assessment protocols, community management models, water quality (typically low TDS, possible contamination).</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>Beetle-inspired surfaces, nanostructured materials, hybrid dew/fog collectors, climate modeling for fog frequency.</p>' } }],
  ...
  game: { id: 'fog-game', title: 'Cloud Catcher', type: 'simulation', description: 'Harvest water from fog', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const wetlandsConservation: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about amazing swamps, marshes, and bogs that clean our water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how wetlands filter water, prevent floods, and support wildlife.', [LearningLevel.HIGH_SCHOOL]: 'Explore wetland ecology, ecosystem services, and restoration techniques.', [LearningLevel.UNDERGRADUATE]: 'Analyze wetland hydrology, biogeochemistry, and functional assessment.', [LearningLevel.GRADUATE]: 'Examine wetland mitigation banking, policy frameworks, and constructed wetlands.', [LearningLevel.PHD]: 'Research wetland carbon dynamics, blue carbon, and climate change impacts.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'wet-1', title: 'Nature\'s Sponges', content: { [LearningLevel.ELEMENTARY]: '<h2>Super Swamps!</h2><p>Wetlands are like giant sponges that soak up water and clean it naturally!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Wetland Services</h2><p>Flood control, water purification, habitat, groundwater recharge, carbon storage. Lost 50%+ globally since 1900.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Wetland Types</h2><p>Marshes (emergent vegetation), swamps (trees), bogs (acidic, peat), fens (alkaline). Each provides different services.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Wetland Function</h2><p>Hydroperiod, hydropattern, water budget. Nutrient cycling, denitrification, sediment trapping, contaminant removal.</p>', [LearningLevel.GRADUATE]: '<h2>Policy & Management</h2><p>Clean Water Act Section 404, no net loss policy, mitigation banking, functional assessment methods.</p>', [LearningLevel.PHD]: '<h2>Climate Interactions</h2><p>Blue carbon sequestration, methane emissions, sea level rise impacts, peatland restoration.</p>' } }],
  ...
  game: { id: 'wet-game', title: 'Wetland Guardian', type: 'simulation', description: 'Protect and restore wetlands', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterRightsPolicy: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn who gets to use water and why sharing is important!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how water is divided up and the rules that protect it.', [LearningLevel.HIGH_SCHOOL]: 'Explore water law, allocation systems, and environmental regulations.', [LearningLevel.UNDERGRADUATE]: 'Analyze riparian vs. prior appropriation, water markets, and transboundary issues.', [LearningLevel.GRADUATE]: 'Examine water governance frameworks, environmental flows, and conflict resolution.', [LearningLevel.PHD]: 'Research water justice, indigenous water rights, and emerging legal frameworks.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'policy-1', title: 'Sharing Water Fairly', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Rules!</h2><p>Just like taking turns on the playground, we have rules for sharing water fairly!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Water Allocation</h2><p>Different systems: first in time (prior appropriation), next to water (riparian), or permits. Droughts create conflicts.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Water Law Systems</h2><p>Prior appropriation (Western US): "first in time, first in right." Riparian (Eastern US): reasonable use by adjacent landowners.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Allocation Mechanisms</h2><p>Administrative allocation, water markets/trading, adjudication. Challenges: overallocation, environmental needs, climate change.</p>', [LearningLevel.GRADUATE]: '<h2>Water Governance</h2><p>Multi-level governance, stakeholder participation, environmental flows, interstate compacts, international treaties.</p>', [LearningLevel.PHD]: '<h2>Justice & Rights</h2><p>Human right to water, indigenous water rights, procedural justice, equitable allocation under scarcity.</p>' } }],
...
export const aquiferRecharge: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how we help refill underground water storage!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how water gets back into underground aquifers.', [LearningLevel.HIGH_SCHOOL]: 'Explore managed aquifer recharge techniques and benefits.', [LearningLevel.UNDERGRADUATE]: 'Analyze MAR system design, hydrogeology, and water quality considerations.', [LearningLevel.GRADUATE]: 'Examine ASR, groundwater banking, and conjunctive use management.', [LearningLevel.PHD]: 'Research reactive transport, clogging mechanisms, and emerging recharge technologies.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'recharge-1', title: 'Refilling Underground', content: { [LearningLevel.ELEMENTARY]: '<h2>Filling Underground Tanks!</h2><p>We can help put water back underground where it\'s stored safely for later!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Natural vs Managed Recharge</h2><p>Rain naturally recharges aquifers slowly. We can speed it up with spreading basins, injection wells, or infiltration galleries.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>MAR Techniques</h2><p>Surface spreading (basins, channels), vadose zone (dry wells), saturated zone (ASR wells). Site selection based on geology.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Design</h2><p>Hydrogeologic characterization, infiltration testing, pretreatment requirements, monitoring network design.</p>', [LearningLevel.GRADUATE]: '<h2>Groundwater Banking</h2><p>Conjunctive use, storage credits, recovery efficiency, water quality changes during storage.</p>', [LearningLevel.PHD]: '<h2>Research Areas</h2><p>Reactive transport modeling, bioclogging, redox changes, trace organic fate, stormwater recharge.</p>' } }],
...
export const waterEfficientLandscaping: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how to have a beautiful garden that doesn\'t need lots of water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover xeriscaping and drought-tolerant landscaping techniques.', [LearningLevel.HIGH_SCHOOL]: 'Explore landscape design principles for water conservation.', [LearningLevel.UNDERGRADUATE]: 'Analyze plant water requirements, irrigation efficiency, and landscape water budgets.', [LearningLevel.GRADUATE]: 'Examine urban landscape water policy, outdoor water use regulations, and incentive programs.', [LearningLevel.PHD]: 'Research urban heat island mitigation, ecosystem services of landscapes, and behavioral change.' },
  topic: 'water-systems',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'land-1', title: 'Smart Gardens', content: { [LearningLevel.ELEMENTARY]: '<h2>Thirsty vs Tough Plants!</h2><p>Some plants need lots of water, but many beautiful plants can grow with very little!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Xeriscaping Principles</h2><p>1) Plan and design, 2) Soil improvement, 3) Efficient irrigation, 4) Mulch, 5) Appropriate turf, 6) Native/drought-tolerant plants, 7) Maintenance.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Design Strategies</h2><p>Hydrozoning (group plants by water needs), reduce turf, capture rainwater, use mulch (reduces evaporation 70%), smart controllers.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Landscape Water Budget</h2><p>ET-based calculations, WUCOLS database, irrigation scheduling, distribution uniformity audits.</p>', [LearningLevel.GRADUATE]: '<h2>Policy Tools</h2><p>Model Water Efficient Landscape Ordinance, turf replacement rebates, water budgets, enforcement.</p>', [LearningLevel.PHD]: '<h2>Research Questions</h2><p>Landscape-scale water savings, behavioral persistence, ecosystem services quantification, equity in green space.</p>' } }],
  ...
  game: { id: 'land-game', title: 'Garden Designer', type: 'puzzle', description: 'Create water-efficient gardens', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterPumpsDistribution: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how water travels through pipes to your home!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how pumps move water through distribution systems.', [LearningLevel.HIGH_SCHOOL]: 'Explore pump types, hydraulics, and distribution network design.', [LearningLevel.UNDERGRADUATE]: 'Analyze pump curves, system curves, and network modeling.', [LearningLevel.GRADUATE]: 'Examine distribution system optimization, energy efficiency, and pressure management.', [LearningLevel.PHD]: 'Research smart water networks, real-time control, and digital twins.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'pump-1', title: 'Moving Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Highways!</h2><p>Pumps push water through pipes like a heart pumps blood!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How Pumps Work</h2><p>Centrifugal pumps spin water outward. Positive displacement pumps push directly.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Distribution Systems</h2><p>Network of mains, service lines, valves, hydrants. Pressure zones for reliability.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Hydraulic Analysis</h2><p>Hazen-Williams equation, pump curves, system head curves, EPANET modeling.</p>', [LearningLevel.GRADUATE]: '<h2>System Optimization</h2><p>Pressure management, variable speed drives, district metering areas.</p>', [LearningLevel.PHD]: '<h2>Smart Networks</h2><p>SCADA, sensors, real-time modeling, predictive maintenance, ML applications.</p>' } }],
  ...
  game: { id: 'pump-game', title: 'Network Engineer', type: 'puzzle', description: 'Build efficient water networks', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterRecyclingReuse: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how used water can be cleaned and used again!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how cities recycle water for different uses.', [LearningLevel.HIGH_SCHOOL]: 'Explore water reuse applications, treatment requirements, and regulations.', [LearningLevel.UNDERGRADUATE]: 'Analyze advanced treatment for potable and non-potable reuse.', [LearningLevel.GRADUATE]: 'Examine direct potable reuse, public perception, and regulatory frameworks.', [LearningLevel.PHD]: 'Research trace contaminant removal, risk assessment, and reuse policy innovation.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'recycle-1', title: 'Water\'s Second Life', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Goes Around!</h2><p>Just like recycling bottles, we can clean used water and use it again!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Reuse Types</h2><p>Non-potable: irrigation, industrial. Potable: indirect or direct. Treatment varies.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Treatment for Reuse</h2><p>Beyond secondary: MF/UF, RO, UV/AOP. Purple pipe for non-potable.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Advanced Treatment</h2><p>Full advanced treatment: MF, RO, UV/AOP. Monitoring and reliability requirements.</p>', [LearningLevel.GRADUATE]: '<h2>Direct Potable Reuse</h2><p>Emerging practice, highest treatment, real-time monitoring, public outreach.</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>CEC fate, QMRA for pathogens, public acceptance, fit-for-purpose optimization.</p>' } }],
  ...
  game: { id: 'recycle-game', title: 'Water Recycler', type: 'simulation', description: 'Manage water recycling', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const aridClimateWater: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how people find water in dry desert places!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover water strategies for desert and drought-prone regions.', [LearningLevel.HIGH_SCHOOL]: 'Explore water management in arid climates.', [LearningLevel.UNDERGRADUATE]: 'Analyze water supply portfolios for water-scarce regions.', [LearningLevel.GRADUATE]: 'Examine integrated strategies for sustainable water in arid environments.', [LearningLevel.PHD]: 'Research climate adaptation, water security, and innovations for water-stressed regions.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'arid-1', title: 'Desert Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Finding Water in Dry Places!</h2><p>Even in deserts, people find clever ways to get water!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Arid Water Sources</h2><p>Deep aquifers, imported water, desalination, rainwater, recycling.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Arid Water Strategies</h2><p>Demand management, efficient irrigation, groundwater banking, traditional methods (qanats).</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Portfolio Approach</h2><p>Diversified supplies, conjunctive use, drought contingency, economic allocation.</p>', [LearningLevel.GRADUATE]: '<h2>Integrated Management</h2><p>Climate projections, adaptive pathways, governance challenges, transboundary cooperation.</p>', [LearningLevel.PHD]: '<h2>Research Needs</h2><p>Non-conventional water, atmospheric harvesting, demand elasticity, sustainable yield.</p>' } }],
  ...
  game: { id: 'arid-game', title: 'Desert Manager', type: 'simulation', description: 'Manage water in dry climates', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterLeakDetection: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how to find sneaky water leaks!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover tools and techniques for finding hidden water leaks.', [LearningLevel.HIGH_SCHOOL]: 'Explore leak detection methods from acoustic to satellite-based.', [LearningLevel.UNDERGRADUATE]: 'Analyze non-revenue water, leak detection technologies, and asset management.', [LearningLevel.GRADUATE]: 'Examine economic level of leakage, pressure management, and loss reduction.', [LearningLevel.PHD]: 'Research AI-based leak detection, pipe condition assessment, and optimal replacement.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'leak-1', title: 'Finding Leaks', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Detectives!</h2><p>A dripping faucet wastes 3,000 gallons a year!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Leak Detection</h2><p>Listen for sounds, check meter, dye tablets, acoustic sensors.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Detection Tech</h2><p>Acoustic loggers, correlators, GPR, infrared, satellite imagery.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Non-Revenue Water</h2><p>Real losses + apparent losses. IWA water balance. Economic level of leakage.</p>', [LearningLevel.GRADUATE]: '<h2>Loss Reduction</h2><p>Active leakage control, pressure management, asset management.</p>', [LearningLevel.PHD]: '<h2>Advanced Detection</h2><p>ML for leak prediction, smart meter analytics, digital twins.</p>' } }],
  ...
  game: { id: 'leak-game', title: 'Leak Detective', type: 'puzzle', description: 'Hunt down water leaks', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const constructedWetlands: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how we build special swamps to clean water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how engineered wetlands treat wastewater using nature.', [LearningLevel.HIGH_SCHOOL]: 'Explore constructed wetland design, types, and treatment mechanisms.', [LearningLevel.UNDERGRADUATE]: 'Analyze wetland hydraulics, vegetation selection, and sizing methods.', [LearningLevel.GRADUATE]: 'Examine hybrid systems, performance optimization, and emerging applications.', [LearningLevel.PHD]: 'Research microbial processes, nutrient dynamics, and wetland modeling.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'cw-1', title: 'Built Wetlands', content: { [LearningLevel.ELEMENTARY]: '<h2>Nature\'s Water Cleaners!</h2><p>We build wetlands with plants to clean dirty water!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How They Work</h2><p>Plant roots support bacteria. Water flows slowly, pollutants removed.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Wetland Types</h2><p>Free water surface, horizontal subsurface flow, vertical flow.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Design Parameters</h2><p>Hydraulic loading, retention time, media selection, plant species.</p>', [LearningLevel.GRADUATE]: '<h2>Advanced Systems</h2><p>Hybrid systems, tidal flow, aerated wetlands, integration with conventional.</p>', [LearningLevel.PHD]: '<h2>Research Areas</h2><p>N removal pathways, P saturation, pharmaceutical removal, modeling.</p>' } }],
  ...
  game: { id: 'cw-game', title: 'Wetland Builder', type: 'simulation', description: 'Create treatment wetlands', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const floodControl: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how we protect communities from too much water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how cities manage flooding and protect people.', [LearningLevel.HIGH_SCHOOL]: 'Explore structural and non-structural flood management approaches.', [LearningLevel.UNDERGRADUATE]: 'Analyze flood hydrology, risk assessment, and mitigation strategies.', [LearningLevel.GRADUATE]: 'Examine integrated flood management, climate adaptation, and resilience.', [LearningLevel.PHD]: 'Research flood modeling, nature-based solutions, and managed retreat.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'flood-1', title: 'Managing Floods', content: { [LearningLevel.ELEMENTARY]: '<h2>Taming Wild Water!</h2><p>Special ways keep communities safe from flooding!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Flood Protection</h2><p>Levees, dams, channels, detention basins, floodplains, warning systems.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Management Approaches</h2><p>Structural (levees, dams), non-structural (zoning, insurance), green infrastructure.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Flood Hydrology</h2><p>Return periods, flood frequency, hydrographs, runoff models, design storms.</p>', [LearningLevel.GRADUATE]: '<h2>Integrated Management</h2><p>Risk-based approaches, climate projections, ecosystem-based adaptation.</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>Compound flooding, uncertainty, nature-based solutions, managed retreat.</p>' } }],
  ...
  game: { id: 'flood-game', title: 'Flood Manager', type: 'simulation', description: 'Protect communities from floods', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterMetersMonitoring: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how we measure water use!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how water meters work and help save water.', [LearningLevel.HIGH_SCHOOL]: 'Explore metering technologies, AMI systems, and data analytics.', [LearningLevel.UNDERGRADUATE]: 'Analyze meter selection, accuracy, and smart metering benefits.', [LearningLevel.GRADUATE]: 'Examine AMI implementation, data analytics, and demand management.', [LearningLevel.PHD]: 'Research high-resolution consumption data, behavioral insights, and AI applications.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'meter-1', title: 'Measuring Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Counting Water Drops!</h2><p>Meters count how much water your family uses!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How Meters Work</h2><p>Mechanical meters spin. Smart meters send data wirelessly.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Meter Technologies</h2><p>Positive displacement, multi-jet, ultrasonic, electromagnetic. AMR vs AMI.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Smart Metering</h2><p>AMI architecture, data transmission, meter data management, leak alerts.</p>', [LearningLevel.GRADUATE]: '<h2>Data Analytics</h2><p>End-use disaggregation, demand forecasting, customer segmentation.</p>', [LearningLevel.PHD]: '<h2>Research</h2><p>High-frequency data mining, behavioral economics, privacy considerations.</p>' } }],
  ...
  game: { id: 'meter-game', title: 'Meter Reader', type: 'puzzle', description: 'Track water usage', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const springWaterSources: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn where water bubbles up from the ground!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how springs form and provide natural water.', [LearningLevel.HIGH_SCHOOL]: 'Explore spring hydrology, development, and protection.', [LearningLevel.UNDERGRADUATE]: 'Analyze spring types, capture systems, and sustainable yield.', [LearningLevel.GRADUATE]: 'Examine spring ecosystems, climate sensitivity, and conservation.', [LearningLevel.PHD]: 'Research spring discharge dynamics, isotope hydrology, and ecosystem dependence.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'spring-1', title: 'Natural Springs', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Fountains in Nature!</h2><p>Springs are where water comes out of the ground by itself!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How Springs Form</h2><p>Groundwater finds a path to surface. Gravity springs, artesian springs, hot springs.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Spring Types</h2><p>Contact springs, fault springs, artesian, karst. Flow varies seasonally.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Spring Development</h2><p>Spring boxes, collection galleries, contamination protection, sustainable yield.</p>', [LearningLevel.GRADUATE]: '<h2>Conservation</h2><p>Springs as groundwater windows, ecosystem dependence, climate impacts.</p>', [LearningLevel.PHD]: '<h2>Research Methods</h2><p>Hydrograph analysis, isotopic signatures, residence time, ecology.</p>' } }],
  ...
  game: { id: 'spring-game', title: 'Spring Finder', type: 'puzzle', description: 'Discover natural water sources', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterSoftening: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn why some water feels slippery!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover what makes water hard and how softeners work.', [LearningLevel.HIGH_SCHOOL]: 'Explore water hardness, softening methods, and impacts.', [LearningLevel.UNDERGRADUATE]: 'Analyze ion exchange, alternative softening technologies.', [LearningLevel.GRADUATE]: 'Examine utility softening, environmental impacts, and alternatives.', [LearningLevel.PHD]: 'Research selective ion removal, membrane softening, brine management.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'soft-1', title: 'Hard vs Soft Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Soap Bubbles!</h2><p>Hard water has minerals. Soft water makes more bubbles!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Water Hardness</h2><p>Calcium and magnesium cause hardness. Creates scale. Softeners remove them.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Softening Methods</h2><p>Ion exchange (salt-based), lime softening, reverse osmosis.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Ion Exchange</h2><p>Resin beads exchange sodium for calcium/magnesium. Regeneration cycle.</p>', [LearningLevel.GRADUATE]: '<h2>Utility Softening</h2><p>Lime-soda process, pellet softening, nanofiltration, environmental impacts.</p>', [LearningLevel.PHD]: '<h2>Research Areas</h2><p>Selective removal, brine minimization, resource recovery, health considerations.</p>' } }],
  ...
  game: { id: 'soft-game', title: 'Water Chemist', type: 'puzzle', description: 'Balance water chemistry', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const emergencyWaterSupply: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how to have safe water during emergencies!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how to prepare for and handle water emergencies.', [LearningLevel.HIGH_SCHOOL]: 'Explore emergency water planning, storage, and treatment.', [LearningLevel.UNDERGRADUATE]: 'Analyze utility emergency response, system resilience, and recovery.', [LearningLevel.GRADUATE]: 'Examine disaster response coordination, temporary systems, and mutual aid.', [LearningLevel.PHD]: 'Research infrastructure resilience, cascading failures, and recovery optimization.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'emerg-1', title: 'Water in Emergencies', content: { [LearningLevel.ELEMENTARY]: '<h2>Be Prepared!</h2><p>Keep one gallon per person per day for three days!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Emergency Prep</h2><p>Store water, know how to purify. Rotate stored water every 6 months.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Emergency Response</h2><p>Boil water notices, alternative supplies, emergency treatment methods.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Resilience</h2><p>Vulnerability assessment, redundancy, emergency interconnections, backup power.</p>', [LearningLevel.GRADUATE]: '<h2>Disaster Response</h2><p>Emergency operations, mutual aid, temporary distribution, communication.</p>', [LearningLevel.PHD]: '<h2>Resilience Research</h2><p>Network analysis, cascading failures, climate extremes, recovery modeling.</p>' } }],
  ...
  game: { id: 'emerg-game', title: 'Emergency Manager', type: 'simulation', description: 'Handle water emergencies', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterPublicHealth: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn why clean water keeps us healthy!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover the connection between safe water and human health.', [LearningLevel.HIGH_SCHOOL]: 'Explore waterborne diseases, water quality standards, and public health.', [LearningLevel.UNDERGRADUATE]: 'Analyze drinking water regulations, risk assessment, and epidemiology.', [LearningLevel.GRADUATE]: 'Examine WASH in development, water security, and health outcomes.', [LearningLevel.PHD]: 'Research waterborne disease dynamics, emerging pathogens, and global health.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'health-1', title: 'Healthy Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Clean Water = Healthy You!</h2><p>Drinking clean water keeps germs away!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Water & Disease</h2><p>Contaminated water carries bacteria, viruses, parasites. Treatment prevents illness.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Water Quality Standards</h2><p>EPA sets limits: MCLs for contaminants. Regular testing required.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Regulatory Framework</h2><p>SDWA, primacy, MCLs vs MCLGs, health advisories, risk assessment.</p>', [LearningLevel.GRADUATE]: '<h2>Global WASH</h2><p>Water, sanitation, hygiene. SDG 6 targets, health burden of unsafe water.</p>', [LearningLevel.PHD]: '<h2>Research Areas</h2><p>Emerging pathogens, climate-disease links, antibiotic resistance.</p>' } }],
  ...
  game: { id: 'health-game', title: 'Health Guardian', type: 'simulation', description: 'Protect community water health', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const agriculturalWater: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how farmers water crops to grow food!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover irrigation methods and water use in farming.', [LearningLevel.HIGH_SCHOOL]: 'Explore agricultural water efficiency and sustainability.', [LearningLevel.UNDERGRADUATE]: 'Analyze crop water requirements and irrigation system design.', [LearningLevel.GRADUATE]: 'Examine agricultural water policy and groundwater depletion.', [LearningLevel.PHD]: 'Research precision agriculture, deficit irrigation, and virtual water trade.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'agri-1', title: 'Watering Crops', content: { [LearningLevel.ELEMENTARY]: '<h2>Thirsty Plants!</h2><p>Farms use 70% of all water for growing food!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Irrigation Methods</h2><p>Flood, furrow, sprinkler, drip. Efficiency: flood 40%, drip 90%+.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Efficient Irrigation</h2><p>Scheduling by ET, soil moisture, plant stress. Deficit irrigation.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Crop Water Needs</h2><p>Evapotranspiration, crop coefficients, water balance, productivity.</p>', [LearningLevel.GRADUATE]: '<h2>Agricultural Policy</h2><p>Water pricing, subsidies, groundwater management, reallocation.</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>Remote sensing, virtual water, water-food-energy nexus, climate adaptation.</p>' } }],
  ...
  game: { id: 'agri-game', title: 'Farm Manager', type: 'simulation', description: 'Grow crops efficiently', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const industrialWater: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how factories use and save water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how industries use water in manufacturing.', [LearningLevel.HIGH_SCHOOL]: 'Explore industrial water use, cooling systems, and efficiency.', [LearningLevel.UNDERGRADUATE]: 'Analyze process water, cooling towers, and industrial reuse.', [LearningLevel.GRADUATE]: 'Examine zero liquid discharge, industrial symbiosis, and water stewardship.', [LearningLevel.PHD]: 'Research advanced industrial treatment, circular economy, and corporate water risk.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'ind-1', title: 'Factory Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Water at Work!</h2><p>Factories use water for cooling, cleaning, and making products!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Industrial Uses</h2><p>Cooling (power plants), processing (food, paper), cleaning. Industry uses ~20% of withdrawals.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Water Systems</h2><p>Once-through cooling, cooling towers, process water, boiler feed water, wastewater treatment.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Efficiency</h2><p>Water audits, recycling loops, cascade use, cooling tower optimization, pretreatment.</p>', [LearningLevel.GRADUATE]: '<h2>Zero Liquid Discharge</h2><p>ZLD systems, brine concentration, crystallization, industrial symbiosis, water stewardship.</p>', [LearningLevel.PHD]: '<h2>Research</h2><p>Fit-for-purpose treatment, advanced oxidation, resource recovery, corporate water accounting.</p>' } }],
  ...
  game: { id: 'ind-game', title: 'Industrial Manager', type: 'simulation', description: 'Optimize factory water use', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterCareers: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about jobs that help keep our water clean!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover careers in water science and engineering.', [LearningLevel.HIGH_SCHOOL]: 'Explore water sector career paths and required education.', [LearningLevel.UNDERGRADUATE]: 'Analyze professional opportunities in water resources.', [LearningLevel.GRADUATE]: 'Examine leadership roles and specializations in water.', [LearningLevel.PHD]: 'Research academic careers, policy roles, and innovation pathways.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 15, [LearningLevel.MIDDLE_SCHOOL]: 25, [LearningLevel.HIGH_SCHOOL]: 40, [LearningLevel.UNDERGRADUATE]: 55, [LearningLevel.GRADUATE]: 75, [LearningLevel.PHD]: 100 },
  lessons: [{ id: 'career-1', title: 'Water Jobs', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Heroes!</h2><p>Many people work to keep our water safe - scientists, engineers, and operators!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Water Careers</h2><p>Hydrologists, water treatment operators, environmental engineers, scientists, planners.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Career Paths</h2><p>Operators (certification), technicians (2-year), engineers (BS/MS), scientists (MS/PhD), managers.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Professional Development</h2><p>PE licensure, certifications, professional societies, continuing education, specializations.</p>', [LearningLevel.GRADUATE]: '<h2>Leadership Roles</h2><p>Utility management, consulting, policy, research direction, entrepreneurship.</p>', [LearningLevel.PHD]: '<h2>Advanced Paths</h2><p>Academic positions, research leadership, policy advisory, international development, innovation.</p>' } }],
  ...
  game: { id: 'career-game', title: 'Career Builder', type: 'puzzle', description: 'Build your water career path', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const oceanCoastalWater: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about the ocean and beaches where land meets sea!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover coastal ecosystems and ocean-freshwater connections.', [LearningLevel.HIGH_SCHOOL]: 'Explore coastal water management, saltwater intrusion, and blue economy.', [LearningLevel.UNDERGRADUATE]: 'Analyze coastal hydrology, estuarine dynamics, and sea level rise impacts.', [LearningLevel.GRADUATE]: 'Examine integrated coastal zone management and climate adaptation.', [LearningLevel.PHD]: 'Research ocean-atmosphere interactions, blue carbon, and coastal resilience.' },
  topic: 'water-systems', estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'ocean-1', title: 'Where Rivers Meet the Sea', content: { [LearningLevel.ELEMENTARY]: '<h2>Ocean Adventures!</h2><p>The ocean holds most of Earth\'s water. Rivers carry freshwater to meet the salty sea!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Coastal Waters</h2><p>Estuaries mix fresh and salt water. Important habitats, nurseries for fish, vulnerable to pollution.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Coastal Challenges</h2><p>Saltwater intrusion, sea level rise, storm surge, coastal erosion, pollution from land.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Coastal Hydrology</h2><p>Tidal dynamics, salinity gradients, submarine groundwater discharge, coastal aquifers.</p>', [LearningLevel.GRADUATE]: '<h2>Integrated Management</h2><p>ICZM frameworks, managed retreat, living shorelines, ecosystem-based adaptation.</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>Blue carbon quantification, ocean acidification impacts, coastal megacity resilience.</p>' } }],
  ...
  game: { id: 'ocean-game', title: 'Coastal Guardian', type: 'simulation', description: 'Protect coastal waters', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
