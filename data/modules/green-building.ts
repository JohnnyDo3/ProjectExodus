...
export const energyEfficiency: Module = {
  ...
  description: { ELEMENTARY: 'Keep your house cozy like a warm blanket!', MIDDLE_SCHOOL: 'Learn how insulation saves energy and money.', HIGH_SCHOOL: 'Understand R-values, thermal bridging, and building envelope principles.', UNDERGRADUATE: 'Analyze heat transfer, insulation materials, and energy code compliance.', GRADUATE: 'Research super-insulation strategies and advanced envelope systems.', PHD: 'Investigate vacuum insulation, aerogels, and dynamic envelope research.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'insulation-1', title: 'Building Blankets', content: { ELEMENTARY: '<h2>Wrap Your House!</h2><p>Insulation is like a cozy blanket for your house. It keeps warm air in during winter and hot air out during summer!</p>', MIDDLE_SCHOOL: '<h2>How Insulation Works</h2><p>Heat always moves from warm to cold. Insulation slows this movement, keeping indoor temperatures comfortable.</p>', HIGH_SCHOOL: '<h2>R-Values and U-Values</h2><p>R-value measures thermal resistance. Higher R = better insulation. U-value is the inverse (lower is better).</p>', UNDERGRADUATE: '<h2>Building Science</h2><p>Heat transfer occurs via conduction, convection, and radiation. Effective insulation addresses all three.</p>', GRADUATE: '<h2>Advanced Envelopes</h2><p>Super-insulated buildings use continuous insulation to eliminate thermal bridging.</p>', PHD: '<h2>Insulation Research</h2><p>Vacuum insulation panels and aerogels offer unprecedented R-values per inch.</p>' } }],
  ...
  game: { id: 'insulation-game', title: 'Energy Saver', type: 'simulation', description: 'Insulate a building to reduce energy use', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const greenRoofs: Module = {
  ...
  description: { ELEMENTARY: 'Imagine grass and flowers growing on your roof!', MIDDLE_SCHOOL: 'Discover how plants on buildings help the environment.', HIGH_SCHOOL: 'Analyze green roof systems, benefits, and installation requirements.', UNDERGRADUATE: 'Evaluate green roof hydrology, structural requirements, and performance metrics.', GRADUATE: 'Research urban heat island mitigation and stormwater management with green infrastructure.', PHD: 'Investigate biodiversity, ecosystem services, and long-term performance of vegetated systems.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'greenroof-1', title: 'Rooftop Gardens', content: { ELEMENTARY: '<h2>Gardens in the Sky!</h2><p>Green roofs have plants growing on top of buildings. They make cities prettier and help birds and bees!</p>', MIDDLE_SCHOOL: '<h2>Green Roof Benefits</h2><p>They absorb rainwater, cool buildings, provide habitat, and look beautiful.</p>', HIGH_SCHOOL: '<h2>Types of Green Roofs</h2><p>Extensive (shallow, low maintenance) vs intensive (deeper, garden-like). Each has different requirements.</p>', UNDERGRADUATE: '<h2>Engineering Requirements</h2><p>Waterproofing, root barriers, drainage layers, growing medium, and structural capacity.</p>', GRADUATE: '<h2>Urban Systems</h2><p>Green roofs as part of urban stormwater management and heat island mitigation strategies.</p>', PHD: '<h2>Ecosystem Research</h2><p>Biodiversity assessments, pollinator habitat, and long-term vegetation dynamics.</p>' } }],
  ...
  game: { id: 'greenroof-game', title: 'Rooftop Gardener', type: 'simulation', description: 'Build and maintain a green roof', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const waterConservation: Module = {
  ...
  description: { ELEMENTARY: 'Save water in your home - every drop counts!', MIDDLE_SCHOOL: 'Learn techniques to reduce water use in buildings.', HIGH_SCHOOL: 'Analyze water-efficient fixtures, greywater, and rainwater systems.', UNDERGRADUATE: 'Evaluate building water balance, recycling systems, and net-zero water strategies.', GRADUATE: 'Research integrated water management and district-scale water systems.', PHD: 'Investigate water-energy nexus and regenerative water systems.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'watercons-1', title: 'Save Every Drop', content: { ELEMENTARY: '<h2>Water Savers!</h2><p>Turn off taps, take shorter showers, and use water-saving toilets to help save our precious water!</p>', MIDDLE_SCHOOL: '<h2>Water-Efficient Fixtures</h2><p>Low-flow showerheads, dual-flush toilets, and aerators use less water without sacrificing comfort.</p>', HIGH_SCHOOL: '<h2>Alternative Water Sources</h2><p>Rainwater harvesting for irrigation, greywater recycling for toilets, and condensate capture.</p>', UNDERGRADUATE: '<h2>Water Balance</h2><p>Calculating building water use, identifying reduction opportunities, and achieving water certifications.</p>', GRADUATE: '<h2>Net-Zero Water</h2><p>Buildings that capture, treat, and reuse all water on-site through closed-loop systems.</p>', PHD: '<h2>Water-Energy Research</h2><p>Energy required for water treatment and the co-optimization of water and energy systems.</p>' } }],
  ...
  game: { id: 'watercons-game', title: 'Water Saver', type: 'simulation', description: 'Reduce building water use', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const indoorAirQuality: Module = {
  ...
  description: { ELEMENTARY: 'Breathe clean air inside your home!', MIDDLE_SCHOOL: 'Learn what affects the air we breathe indoors.', HIGH_SCHOOL: 'Analyze pollutant sources, ventilation, and filtration strategies.', UNDERGRADUATE: 'Evaluate IAQ standards, measurement methods, and HVAC design for healthy air.', GRADUATE: 'Research sick building syndrome, VOCs, and advanced air purification.', PHD: 'Investigate exposure assessment, health outcomes, and emerging contaminants.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'iaq-1', title: 'Clean Air Inside', content: { ELEMENTARY: '<h2>Fresh Air!</h2><p>Opening windows, using air filters, and choosing natural materials help keep indoor air clean and healthy!</p>', MIDDLE_SCHOOL: '<h2>Air Pollutants</h2><p>Dust, mold, chemicals from furniture, and CO2 from breathing can make indoor air unhealthy.</p>', HIGH_SCHOOL: '<h2>Ventilation Strategies</h2><p>Natural ventilation, mechanical systems, and air filtration work together for healthy indoor air.</p>', UNDERGRADUATE: '<h2>IAQ Standards</h2><p>ASHRAE 62.1 ventilation requirements, MERV ratings, and CO2-based demand control.</p>', GRADUATE: '<h2>Advanced IAQ</h2><p>HEPA and ULPA filtration, UV germicidal irradiation, and bipolar ionization.</p>', PHD: '<h2>IAQ Research</h2><p>Emerging contaminants, real-time monitoring, and health outcome studies.</p>' } }],
  ...
  game: { id: 'iaq-game', title: 'Fresh Air Expert', type: 'puzzle', description: 'Improve indoor air quality', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const daylighting: Module = {
  ...
  description: { ELEMENTARY: 'Let the sunshine in to light your room!', MIDDLE_SCHOOL: 'Learn how buildings can use natural light effectively.', HIGH_SCHOOL: 'Analyze daylighting strategies, glare control, and energy savings.', UNDERGRADUATE: 'Evaluate daylight metrics, simulation tools, and integrated lighting design.', GRADUATE: 'Research circadian lighting, dynamic facades, and advanced daylighting systems.', PHD: 'Investigate non-visual effects of light and human-centric lighting research.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'daylight-1', title: 'Natural Light', content: { ELEMENTARY: '<h2>Sunshine Inside!</h2><p>Windows let in natural light. It makes us happy and saves electricity!</p>', MIDDLE_SCHOOL: '<h2>Designing with Light</h2><p>Window placement, skylights, and light shelves bring daylight deep into buildings.</p>', HIGH_SCHOOL: '<h2>Balancing Light</h2><p>Too much direct sun causes glare and overheating. Diffusers and shading help.</p>', UNDERGRADUATE: '<h2>Daylight Metrics</h2><p>Daylight autonomy, spatial daylight autonomy, and annual sunlight exposure calculations.</p>', GRADUATE: '<h2>Dynamic Systems</h2><p>Automated blinds, electrochromic glazing, and integrated controls optimize daylight.</p>', PHD: '<h2>Circadian Research</h2><p>Light\'s effects on sleep, mood, and health - designing for human wellbeing.</p>' } }],
  ...
  game: { id: 'daylight-game', title: 'Light Architect', type: 'puzzle', description: 'Design spaces with natural light', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const efficientHVAC: Module = {
  ...
  description: { ELEMENTARY: 'Learn how buildings stay comfortable in any weather!', MIDDLE_SCHOOL: 'Discover efficient heating and cooling technologies.', HIGH_SCHOOL: 'Analyze HVAC system types, efficiency ratings, and controls.', UNDERGRADUATE: 'Evaluate system selection, load calculations, and energy optimization.', GRADUATE: 'Research variable refrigerant flow, radiant systems, and decarbonization.', PHD: 'Investigate next-generation cooling, thermal storage, and grid integration.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'hvac-1', title: 'Heating and Cooling', content: { ELEMENTARY: '<h2>Stay Comfy!</h2><p>Furnaces keep us warm, air conditioners keep us cool. New ones use less energy!</p>', MIDDLE_SCHOOL: '<h2>HVAC Efficiency</h2><p>Heat pumps move heat instead of making it, using much less energy than traditional systems.</p>', HIGH_SCHOOL: '<h2>System Types</h2><p>Central air, mini-splits, VRF, and radiant systems each have advantages for different buildings.</p>', UNDERGRADUATE: '<h2>Load Calculations</h2><p>Manual J for residential, ASHRAE methods for commercial - proper sizing is critical.</p>', GRADUATE: '<h2>Decarbonization</h2><p>Electrification, heat pumps, and renewable integration for zero-carbon HVAC.</p>', PHD: '<h2>HVAC Research</h2><p>Solid-state cooling, thermal batteries, and smart grid integration.</p>' } }],
  ...
  game: { id: 'hvac-game', title: 'Climate Controller', type: 'simulation', description: 'Design efficient HVAC systems', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const smartBuilding: Module = {
  ...
  description: { ELEMENTARY: 'Buildings that think and save energy automatically!', MIDDLE_SCHOOL: 'Learn how sensors and computers make buildings smarter.', HIGH_SCHOOL: 'Analyze building automation, IoT sensors, and energy management.', UNDERGRADUATE: 'Evaluate BAS architecture, protocols, and cybersecurity considerations.', GRADUATE: 'Research machine learning for buildings, predictive control, and digital twins.', PHD: 'Investigate occupancy-driven control, fault detection, and autonomous building systems.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'smart-1', title: 'Clever Buildings', content: { ELEMENTARY: '<h2>Smart Homes!</h2><p>Lights turn off when you leave, thermostats learn what you like - smart buildings save energy!</p>', MIDDLE_SCHOOL: '<h2>Building Automation</h2><p>Sensors detect occupancy, temperature, and light to automatically adjust systems.</p>', HIGH_SCHOOL: '<h2>IoT in Buildings</h2><p>Internet of Things connects sensors, controls, and analytics for optimization.</p>', UNDERGRADUATE: '<h2>BAS Design</h2><p>Building automation system architecture, protocols (BACnet, Modbus), and integration.</p>', GRADUATE: '<h2>Predictive Control</h2><p>Machine learning predicts loads and optimizes operation proactively.</p>', PHD: '<h2>Smart Building Research</h2><p>Digital twins, autonomous systems, and advanced fault detection diagnostics.</p>' } }],
  ...
  game: { id: 'smart-game', title: 'Building Brain', type: 'simulation', description: 'Automate a building for efficiency', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const windowsGlazing: Module = {
  ...
  description: { ELEMENTARY: 'Windows aren\'t just for looking out - they\'re important!', MIDDLE_SCHOOL: 'Learn how windows affect building energy and comfort.', HIGH_SCHOOL: 'Analyze glazing types, U-factors, SHGC, and visible transmittance.', UNDERGRADUATE: 'Evaluate window selection, frame materials, and performance optimization.', GRADUATE: 'Research dynamic glazing, vacuum glazing, and facade engineering.', PHD: 'Investigate transparent photovoltaics and next-generation glazing technologies.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'windows-1', title: 'Amazing Windows', content: { ELEMENTARY: '<h2>Window Power!</h2><p>Special windows keep heat in during winter and out during summer while letting in light!</p>', MIDDLE_SCHOOL: '<h2>Window Technology</h2><p>Double and triple pane windows with gas fills and coatings dramatically improve efficiency.</p>', HIGH_SCHOOL: '<h2>Glazing Properties</h2><p>U-factor (insulation), SHGC (solar heat gain), and VT (visible light) must be balanced.</p>', UNDERGRADUATE: '<h2>Window Selection</h2><p>Matching glazing properties to climate and orientation for optimal performance.</p>', GRADUATE: '<h2>Dynamic Glazing</h2><p>Electrochromic and thermochromic glass that changes properties on demand.</p>', PHD: '<h2>Glazing Research</h2><p>Transparent PV, vacuum insulated glass, and switchable smart windows.</p>' } }],
  ...
  game: { id: 'windows-game', title: 'Glazing Expert', type: 'puzzle', description: 'Select optimal windows for buildings', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const geothermalSystems: Module = {
  ...
  description: { ELEMENTARY: 'Use the Earth\'s heat to warm and cool your home!', MIDDLE_SCHOOL: 'Discover how ground-source heat pumps work.', HIGH_SCHOOL: 'Analyze geothermal system types, design, and efficiency.', UNDERGRADUATE: 'Evaluate ground loop sizing, equipment selection, and economic analysis.', GRADUATE: 'Research advanced configurations, district systems, and hybrid approaches.', PHD: 'Investigate ground thermal properties, long-term performance, and geo-exchange research.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'geo-1', title: 'Earth Energy', content: { ELEMENTARY: '<h2>Underground Heat!</h2><p>The ground stays the same temperature all year. We can use pipes to heat and cool buildings!</p>', MIDDLE_SCHOOL: '<h2>Ground-Source Heat Pumps</h2><p>Pipes in the ground exchange heat with the earth - cooler than air in summer, warmer in winter.</p>', HIGH_SCHOOL: '<h2>System Types</h2><p>Horizontal, vertical, and pond loops each suit different sites and budgets.</p>', UNDERGRADUATE: '<h2>Loop Design</h2><p>Ground conductivity testing, bore field sizing, and heat exchanger selection.</p>', GRADUATE: '<h2>District Geothermal</h2><p>Shared bore fields serving multiple buildings for economy of scale.</p>', PHD: '<h2>Geothermal Research</h2><p>Thermal response testing, long-term ground temperature changes, and optimization.</p>' } }],
  ...
  game: { id: 'geo-game', title: 'Earth Energy Engineer', type: 'simulation', description: 'Install geothermal systems', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const buildingSolar: Module = {
  ...
  description: { ELEMENTARY: 'Turn your roof into a power plant!', MIDDLE_SCHOOL: 'Learn how buildings can generate their own electricity.', HIGH_SCHOOL: 'Analyze rooftop PV, BIPV products, and system sizing.', UNDERGRADUATE: 'Evaluate solar resource assessment, inverter selection, and grid connection.', GRADUATE: 'Research building-integrated photovoltaics and solar thermal integration.', PHD: 'Investigate transparent solar, solar facades, and advanced cell technologies.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'solar-1', title: 'Solar Buildings', content: { ELEMENTARY: '<h2>Power from the Sun!</h2><p>Solar panels on roofs turn sunshine into electricity to power your home!</p>', MIDDLE_SCHOOL: '<h2>Rooftop Solar</h2><p>Photovoltaic panels convert sunlight to electricity, offsetting grid power use.</p>', HIGH_SCHOOL: '<h2>BIPV</h2><p>Building-integrated photovoltaics replace conventional materials - solar shingles, facades, windows.</p>', UNDERGRADUATE: '<h2>System Design</h2><p>Resource assessment, panel layout, inverter sizing, and utility interconnection.</p>', GRADUATE: '<h2>Advanced Integration</h2><p>Solar thermal, PVT hybrids, and facade-integrated systems for net-zero buildings.</p>', PHD: '<h2>Solar Research</h2><p>Perovskites, transparent cells, and solar windows for maximum integration.</p>' } }],
  ...
  game: { id: 'solar-game', title: 'Solar Architect', type: 'simulation', description: 'Maximize building solar potential', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const rainwaterHarvesting: Module = {
  ...
  description: { ELEMENTARY: 'Catch rain from the sky to use in your home!', MIDDLE_SCHOOL: 'Learn how to collect and use rainwater.', HIGH_SCHOOL: 'Analyze rainwater harvesting system design and water quality.', UNDERGRADUATE: 'Evaluate collection, storage, treatment, and distribution systems.', GRADUATE: 'Research integrated rainwater management and building water resilience.', PHD: 'Investigate urban water cycles and rainwater quality dynamics.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'rain-1', title: 'Catching Rain', content: { ELEMENTARY: '<h2>Free Water from the Sky!</h2><p>Roofs collect rainwater into barrels. Use it to water plants!</p>', MIDDLE_SCHOOL: '<h2>Rainwater Systems</h2><p>Gutters, filters, and storage tanks collect and store rainwater for later use.</p>', HIGH_SCHOOL: '<h2>System Components</h2><p>Catchment area, conveyance, first-flush diverters, storage, and treatment.</p>', UNDERGRADUATE: '<h2>System Sizing</h2><p>Calculating catchment yield, storage capacity, and demand matching.</p>', GRADUATE: '<h2>Water Resilience</h2><p>Rainwater as part of building water security and climate adaptation.</p>', PHD: '<h2>Rainwater Research</h2><p>Quality modeling, treatment optimization, and health risk assessment.</p>' } }],
...
export const biophilicDesign: Module = {
  ...
  description: { ELEMENTARY: 'Bring nature inside buildings to feel happier!', MIDDLE_SCHOOL: 'Discover how nature in buildings improves wellbeing.', HIGH_SCHOOL: 'Analyze biophilic design principles and implementation strategies.', UNDERGRADUATE: 'Evaluate biophilic patterns, evidence base, and design integration.', GRADUATE: 'Research health outcomes, productivity impacts, and biophilic urbanism.', PHD: 'Investigate human-nature connection, restorative environments, and quantification methods.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'biophilic-1', title: 'Nature in Buildings', content: { ELEMENTARY: '<h2>Green Buildings!</h2><p>Plants, natural light, and nature views inside buildings make people feel happier and healthier!</p>', MIDDLE_SCHOOL: '<h2>Biophilia</h2><p>Humans evolved with nature. We feel better when buildings include natural elements.</p>', HIGH_SCHOOL: '<h2>Design Patterns</h2><p>Visual nature connection, natural light, natural materials, and nature patterns.</p>', UNDERGRADUATE: '<h2>Evidence Base</h2><p>Research shows biophilic design reduces stress, improves cognition, and enhances wellbeing.</p>', GRADUATE: '<h2>Implementation</h2><p>Integrating biophilic elements across building types and climates.</p>', PHD: '<h2>Biophilic Research</h2><p>Measuring outcomes, dose-response relationships, and optimal implementation.</p>' } }],
  ...
  game: { id: 'biophilic-game', title: 'Nature Architect', type: 'puzzle', description: 'Create nature-connected spaces', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const greenCertifications: Module = {
  ...
  description: { ELEMENTARY: 'Buildings can earn gold stars for being green!', MIDDLE_SCHOOL: 'Learn about systems that certify sustainable buildings.', HIGH_SCHOOL: 'Compare LEED, Passive House, WELL, and other certification systems.', UNDERGRADUATE: 'Evaluate certification requirements, credits, and documentation.', GRADUATE: 'Research certification effectiveness, market impacts, and evolution.', PHD: 'Investigate certification outcomes, performance verification, and system improvement.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'cert-1', title: 'Building Awards', content: { ELEMENTARY: '<h2>Green Building Stars!</h2><p>LEED and other programs give awards to buildings that help the planet!</p>', MIDDLE_SCHOOL: '<h2>Certification Systems</h2><p>LEED, Passive House, BREEAM, and Living Building Challenge each measure sustainability differently.</p>', HIGH_SCHOOL: '<h2>LEED Categories</h2><p>Energy, water, materials, indoor quality, site, innovation - points in each category.</p>', UNDERGRADUATE: '<h2>Documentation</h2><p>Submitting credits, calculations, and evidence for certification.</p>', GRADUATE: '<h2>Market Impact</h2><p>Certification effects on rent, value, and occupant satisfaction.</p>', PHD: '<h2>Certification Research</h2><p>Performance gap studies, outcome measurement, and system evolution.</p>' } }],
  ...
  game: { id: 'cert-game', title: 'Green Building Certifier', type: 'simulation', description: 'Earn green building certifications', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const naturalBuilding: Module = {
  ...
  description: { ELEMENTARY: 'Build with earth, straw, and other natural stuff!', MIDDLE_SCHOOL: 'Discover traditional and modern natural building techniques.', HIGH_SCHOOL: 'Analyze straw bale, cob, rammed earth, and earthbag construction.', UNDERGRADUATE: 'Evaluate structural performance, code compliance, and modern applications.', GRADUATE: 'Research thermal performance, moisture dynamics, and scaling challenges.', PHD: 'Investigate natural building science, code development, and performance optimization.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'natural-1', title: 'Earth Buildings', content: { ELEMENTARY: '<h2>Houses from the Earth!</h2><p>People build houses from mud, straw, and earth. They\'re natural and cozy!</p>', MIDDLE_SCHOOL: '<h2>Natural Methods</h2><p>Straw bale, cob, adobe, rammed earth - ancient techniques updated for modern buildings.</p>', HIGH_SCHOOL: '<h2>Building Systems</h2><p>Each method has unique properties for insulation, thermal mass, and moisture management.</p>', UNDERGRADUATE: '<h2>Modern Applications</h2><p>Code compliance, structural engineering, and professional natural building.</p>', GRADUATE: '<h2>Performance Analysis</h2><p>Hygrothermal modeling, durability studies, and climate adaptation.</p>', PHD: '<h2>Natural Building Research</h2><p>Material science, testing standards, and scalable applications.</p>' } }],
  ...
  game: { id: 'natural-game', title: 'Earth Builder', type: 'simulation', description: 'Construct natural buildings', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const buildingRetrofits: Module = {
  ...
  description: { ELEMENTARY: 'Make old buildings green and efficient!', MIDDLE_SCHOOL: 'Learn how to improve existing buildings for sustainability.', HIGH_SCHOOL: 'Analyze energy audit processes and retrofit strategies.', UNDERGRADUATE: 'Evaluate deep energy retrofits, financing, and project delivery.', GRADUATE: 'Research mass retrofit strategies and building stock transformation.', PHD: 'Investigate retrofit economics, policy effectiveness, and scaling approaches.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'retrofit-1', title: 'Green Makeovers', content: { ELEMENTARY: '<h2>Building Makeovers!</h2><p>Old buildings can get upgrades like better insulation and new windows to save energy!</p>', MIDDLE_SCHOOL: '<h2>Retrofit Options</h2><p>Insulation, air sealing, window upgrades, and HVAC improvements.</p>', HIGH_SCHOOL: '<h2>Energy Audits</h2><p>Blower door tests, infrared scans, and analysis identify improvement opportunities.</p>', UNDERGRADUATE: '<h2>Deep Retrofits</h2><p>Whole-building approaches that achieve 50%+ energy reduction.</p>', GRADUATE: '<h2>Mass Retrofits</h2><p>Scaling strategies, industrialized approaches, and policy drivers.</p>', PHD: '<h2>Retrofit Research</h2><p>Cost-effectiveness, performance measurement, and market transformation.</p>' } }],
  ...
  game: { id: 'retrofit-game', title: 'Building Upgrader', type: 'simulation', description: 'Retrofit buildings for efficiency', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const netZeroBuildings: Module = {
  ...
  description: { ELEMENTARY: 'Buildings that make as much energy as they use!', MIDDLE_SCHOOL: 'Learn how buildings can produce their own energy.', HIGH_SCHOOL: 'Analyze net zero energy design strategies and calculations.', UNDERGRADUATE: 'Evaluate net zero definitions, metrics, and design approaches.', GRADUATE: 'Research net zero policy, grid interaction, and carbon accounting.', PHD: 'Investigate net zero scalability, temporal matching, and embodied carbon.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'netzero-1', title: 'Energy Balance', content: { ELEMENTARY: '<h2>Zero Energy!</h2><p>Super-efficient buildings with solar panels can make all the energy they need!</p>', MIDDLE_SCHOOL: '<h2>Net Zero Concept</h2><p>Reduce energy use dramatically, then generate enough renewable energy to cover the rest.</p>', HIGH_SCHOOL: '<h2>Net Zero Design</h2><p>Efficiency first, then renewables. Annual energy production equals consumption.</p>', UNDERGRADUATE: '<h2>Definitions</h2><p>Net zero energy, net zero carbon, source vs site energy, and boundary issues.</p>', GRADUATE: '<h2>Grid Interaction</h2><p>Time-of-use considerations, storage, and grid carbon intensity.</p>', PHD: '<h2>Net Zero Research</h2><p>Embodied carbon, temporal matching, and whole-life carbon assessment.</p>' } }],
  ...
  game: { id: 'netzero-game', title: 'Zero Energy Builder', type: 'simulation', description: 'Create a net zero building', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const healthyBuilding: Module = {
  ...
  description: { ELEMENTARY: 'Buildings that help keep you healthy!', MIDDLE_SCHOOL: 'Learn how buildings affect our health and wellbeing.', HIGH_SCHOOL: 'Analyze health-focused design strategies and WELL certification.', UNDERGRADUATE: 'Evaluate evidence-based design for health, comfort, and productivity.', GRADUATE: 'Research building health impacts, measurement methods, and interventions.', PHD: 'Investigate dose-response relationships and building health outcomes research.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'healthy-1', title: 'Buildings for Health', content: { ELEMENTARY: '<h2>Healthy Spaces!</h2><p>Good buildings have fresh air, natural light, and spaces to move around!</p>', MIDDLE_SCHOOL: '<h2>Health Factors</h2><p>Air quality, lighting, temperature, acoustics, and access to nature affect health.</p>', HIGH_SCHOOL: '<h2>WELL Building Standard</h2><p>Certification focused on human health through air, water, nourishment, light, fitness, comfort, and mind.</p>', UNDERGRADUATE: '<h2>Evidence-Based Design</h2><p>Using research to inform design decisions that improve occupant health.</p>', GRADUATE: '<h2>Health Measurement</h2><p>Surveys, sensors, and biomarkers for assessing building health impacts.</p>', PHD: '<h2>Health Research</h2><p>Quantifying health benefits, long-term studies, and intervention effectiveness.</p>' } }],
  ...
  game: { id: 'healthy-game', title: 'Health Building Expert', type: 'puzzle', description: 'Create healthy building environments', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const buildingAcoustics: Module = {
  ...
  description: { ELEMENTARY: 'Make buildings quieter and sound better!', MIDDLE_SCHOOL: 'Learn how buildings control sound.', HIGH_SCHOOL: 'Analyze sound transmission, absorption, and acoustic design.', UNDERGRADUATE: 'Evaluate STC ratings, NRC values, and acoustic design strategies.', GRADUATE: 'Research acoustic comfort, speech privacy, and sustainable acoustics.', PHD: 'Investigate psychoacoustics, acoustic modeling, and innovative materials.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'acoustics-1', title: 'Sound Control', content: { ELEMENTARY: '<h2>Quiet Please!</h2><p>Good buildings keep noise out and help sounds be clear inside!</p>', MIDDLE_SCHOOL: '<h2>Sound Basics</h2><p>Sound travels through air and materials. Design can block, absorb, or shape sound.</p>', HIGH_SCHOOL: '<h2>Acoustic Principles</h2><p>Sound transmission loss, absorption coefficients, and reverberation time.</p>', UNDERGRADUATE: '<h2>Acoustic Design</h2><p>STC ratings for walls, NRC for finishes, and room acoustics optimization.</p>', GRADUATE: '<h2>Advanced Acoustics</h2><p>Speech privacy, background noise control, and sustainable materials.</p>', PHD: '<h2>Acoustics Research</h2><p>Computational acoustics, novel absorbers, and human response studies.</p>' } }],
  ...
  game: { id: 'acoustics-game', title: 'Acoustic Engineer', type: 'puzzle', description: 'Design for good acoustics', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const sustainableLighting: Module = {
  ...
  description: { ELEMENTARY: 'Light up buildings while saving energy!', MIDDLE_SCHOOL: 'Learn about energy-efficient lighting options.', HIGH_SCHOOL: 'Analyze LED technology, controls, and lighting design principles.', UNDERGRADUATE: 'Evaluate lighting power density, controls, and daylighting integration.', GRADUATE: 'Research human-centric lighting and advanced control strategies.', PHD: 'Investigate lighting quality metrics, spectral optimization, and health effects.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'lighting-1', title: 'Smart Lights', content: { ELEMENTARY: '<h2>Bright Ideas!</h2><p>LED lights use less energy and last longer than old bulbs!</p>', MIDDLE_SCHOOL: '<h2>Efficient Lighting</h2><p>LEDs, occupancy sensors, and daylight dimming cut lighting energy use dramatically.</p>', HIGH_SCHOOL: '<h2>Lighting Design</h2><p>Footcandle requirements, color temperature, and lamp selection.</p>', UNDERGRADUATE: '<h2>Lighting Power</h2><p>Watts per square foot limits, controls credits, and daylighting integration.</p>', GRADUATE: '<h2>Human-Centric</h2><p>Tunable lighting, circadian support, and individual control.</p>', PHD: '<h2>Lighting Research</h2><p>Spectral power distribution, melanopic metrics, and long-term health effects.</p>' } }],
  ...
  game: { id: 'lighting-game', title: 'Light Master', type: 'simulation', description: 'Create efficient lighting designs', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const resilientBuilding: Module = {
  ...
  description: { ELEMENTARY: 'Build strong buildings that can handle storms!', MIDDLE_SCHOOL: 'Learn how buildings can resist natural disasters.', HIGH_SCHOOL: 'Analyze resilient design strategies for climate adaptation.', UNDERGRADUATE: 'Evaluate passive survivability, backup systems, and hazard mitigation.', GRADUATE: 'Research climate adaptation, infrastructure interdependencies, and community resilience.', PHD: 'Investigate resilience metrics, risk assessment, and adaptive capacity.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'resilient-1', title: 'Strong Buildings', content: { ELEMENTARY: '<h2>Weather-Proof!</h2><p>Strong buildings protect people during storms, heat waves, and other extreme weather!</p>', MIDDLE_SCHOOL: '<h2>Resilient Design</h2><p>Buildings designed to withstand floods, hurricanes, earthquakes, and power outages.</p>', HIGH_SCHOOL: '<h2>Climate Adaptation</h2><p>Designing for future climate conditions including extreme heat, flooding, and storms.</p>', UNDERGRADUATE: '<h2>Passive Survivability</h2><p>Buildings that maintain habitable conditions during extended power outages.</p>', GRADUATE: '<h2>System Integration</h2><p>Backup power, water storage, and community resilience hubs.</p>', PHD: '<h2>Resilience Research</h2><p>Quantifying resilience, performance under stress, and adaptation pathways.</p>' } }],
  ...
  game: { id: 'resilient-game', title: 'Storm Builder', type: 'simulation', description: 'Build resilient structures', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const adaptiveReuse: Module = {
  ...
  description: { ELEMENTARY: 'Give old buildings exciting new lives!', MIDDLE_SCHOOL: 'Learn how old buildings can become something new.', HIGH_SCHOOL: 'Analyze adaptive reuse strategies, challenges, and benefits.', UNDERGRADUATE: 'Evaluate historic preservation, code compliance, and design integration.', GRADUATE: 'Research embodied carbon benefits, policy incentives, and market factors.', PHD: 'Investigate reuse versus new construction lifecycle impacts and decision frameworks.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'adaptive-1', title: 'New Life for Old Buildings', content: { ELEMENTARY: '<h2>Building Transformations!</h2><p>Old factories become apartments! Churches become restaurants! It\'s recycling for buildings!</p>', MIDDLE_SCHOOL: '<h2>Creative Reuse</h2><p>Instead of demolishing, transform buildings for new purposes while keeping their character.</p>', HIGH_SCHOOL: '<h2>Reuse Strategies</h2><p>Assessing buildings for reuse potential, addressing code compliance, and preserving character.</p>', UNDERGRADUATE: '<h2>Design Integration</h2><p>Balancing preservation with modern performance requirements.</p>', GRADUATE: '<h2>Carbon Benefits</h2><p>Avoided embodied carbon from reuse versus demolition and new construction.</p>', PHD: '<h2>Reuse Research</h2><p>Decision frameworks, lifecycle comparisons, and policy effectiveness.</p>' } }],
  ...
  game: { id: 'adaptive-game', title: 'Reuse Master', type: 'simulation', description: 'Transform old buildings for new purposes', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const greenBuildingEconomics: Module = {
  ...
  description: { ELEMENTARY: 'Green buildings can save money too!', MIDDLE_SCHOOL: 'Learn how sustainable buildings make financial sense.', HIGH_SCHOOL: 'Analyze lifecycle costs, payback periods, and financial incentives.', UNDERGRADUATE: 'Evaluate ROI, discount rates, and value of non-energy benefits.', GRADUATE: 'Research green premium, financing mechanisms, and market valuation.', PHD: 'Investigate total value proposition, externalities, and economic modeling.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'economics-1', title: 'Green Saves Green', content: { ELEMENTARY: '<h2>Saving Money!</h2><p>Energy-efficient buildings cost less to run. Lower bills mean more money for other things!</p>', MIDDLE_SCHOOL: '<h2>Cost and Savings</h2><p>Green buildings may cost more upfront but save money through lower energy and water bills.</p>', HIGH_SCHOOL: '<h2>Lifecycle Costing</h2><p>Looking beyond first cost to include operating, maintenance, and replacement costs.</p>', UNDERGRADUATE: '<h2>Financial Analysis</h2><p>NPV, IRR, simple payback, and making the business case for green building.</p>', GRADUATE: '<h2>Green Value</h2><p>Rent premiums, higher occupancy, and asset value of green-certified buildings.</p>', PHD: '<h2>Economic Research</h2><p>Externality valuation, split incentives, and policy economic analysis.</p>' } }],
  ...
  game: { id: 'economics-game', title: 'Green Budget Builder', type: 'simulation', description: 'Balance costs and savings for green buildings', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const embodiedCarbon: Module = {
  ...
  description: { ELEMENTARY: 'Buildings have carbon hiding inside them!', MIDDLE_SCHOOL: 'Learn about the carbon in building materials.', HIGH_SCHOOL: 'Analyze embodied carbon sources, measurement, and reduction strategies.', UNDERGRADUATE: 'Evaluate whole building lifecycle carbon and reduction pathways.', GRADUATE: 'Research decarbonization, carbon neutral buildings, and policy approaches.', PHD: 'Investigate carbon accounting methods, uncertainty, and system boundaries.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'embodied-1', title: 'Hidden Carbon', content: { ELEMENTARY: '<h2>Carbon in Materials!</h2><p>Making cement and steel releases carbon. Choosing wood and recycled materials helps!</p>', MIDDLE_SCHOOL: '<h2>Embodied vs Operating</h2><p>Embodied carbon comes from making materials. Operating carbon comes from running buildings.</p>', HIGH_SCHOOL: '<h2>Carbon Sources</h2><p>Concrete and steel account for most embodied carbon. Low-carbon alternatives exist.</p>', UNDERGRADUATE: '<h2>Carbon Accounting</h2><p>Stages A1-A5, B, C, and D in whole building lifecycle carbon assessment.</p>', GRADUATE: '<h2>Decarbonization</h2><p>Material substitution, optimization, and carbon-negative approaches.</p>', PHD: '<h2>Carbon Research</h2><p>Methodology comparison, data quality, and whole-life carbon optimization.</p>' } }],
  ...
  game: { id: 'embodied-game', title: 'Carbon Reducer', type: 'simulation', description: 'Minimize embodied carbon in buildings', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const buildingCommissioning: Module = {
  ...
  description: { ELEMENTARY: 'Make sure buildings work the way they should!', MIDDLE_SCHOOL: 'Learn how buildings are tested to work properly.', HIGH_SCHOOL: 'Analyze commissioning processes, benefits, and requirements.', UNDERGRADUATE: 'Evaluate commissioning scope, methods, and documentation.', GRADUATE: 'Research continuous commissioning and monitoring-based Cx.', PHD: 'Investigate commissioning effectiveness, automation, and performance assurance.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'cx-1', title: 'Testing Buildings', content: { ELEMENTARY: '<h2>Does It Work?</h2><p>Before moving in, experts test everything to make sure the building works right!</p>', MIDDLE_SCHOOL: '<h2>Commissioning Basics</h2><p>Testing HVAC, lighting, controls, and other systems to verify proper operation.</p>', HIGH_SCHOOL: '<h2>Cx Process</h2><p>Design review, functional testing, training, and documentation for building systems.</p>', UNDERGRADUATE: '<h2>Cx Requirements</h2><p>Scope, specifications, and LEED/ASHRAE commissioning requirements.</p>', GRADUATE: '<h2>Continuous Cx</h2><p>Ongoing monitoring and optimization through building lifespan.</p>', PHD: '<h2>Cx Research</h2><p>Automated fault detection, machine learning, and performance guarantees.</p>' } }],
  ...
  game: { id: 'cx-game', title: 'Building Tester', type: 'simulation', description: 'Test and verify building systems', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const urbanGreenBuildings: Module = {
  ...
  description: { ELEMENTARY: 'Make cities greener with smart buildings!', MIDDLE_SCHOOL: 'Learn how green buildings fit into cities.', HIGH_SCHOOL: 'Analyze site selection, transit access, and urban context.', UNDERGRADUATE: 'Evaluate urban heat islands, district systems, and walkability.', GRADUATE: 'Research urban metabolism, green infrastructure integration, and district energy.', PHD: 'Investigate building-city interactions and urban sustainability transitions.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'urban-1', title: 'City Green', content: { ELEMENTARY: '<h2>Green Cities!</h2><p>Buildings near buses and trains help people drive less. That\'s good for the air!</p>', MIDDLE_SCHOOL: '<h2>Location Matters</h2><p>Where a building is located affects transportation, energy, and community.</p>', HIGH_SCHOOL: '<h2>Urban Context</h2><p>Transit access, walkability, mixed use, and sustainable site design.</p>', UNDERGRADUATE: '<h2>Urban Systems</h2><p>Heat islands, stormwater, and building impacts on urban environment.</p>', GRADUATE: '<h2>District Approaches</h2><p>District energy, shared infrastructure, and neighborhood-scale sustainability.</p>', PHD: '<h2>Urban Research</h2><p>Building-urban interactions, policy levers, and transition pathways.</p>' } }],
  ...
  game: { id: 'urban-game', title: 'City Planner', type: 'simulation', description: 'Plan green building locations in cities', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const massTimber: Module = {
  ...
  description: { ELEMENTARY: 'Build tall buildings with wood!', MIDDLE_SCHOOL: 'Discover how wood can replace steel and concrete.', HIGH_SCHOOL: 'Analyze CLT, glulam, and mass timber structural systems.', UNDERGRADUATE: 'Evaluate mass timber design, fire safety, and code compliance.', GRADUATE: 'Research mass timber carbon benefits and market transformation.', PHD: 'Investigate mass timber performance, innovation, and sustainable forestry.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'timber-1', title: 'Wooden Towers', content: { ELEMENTARY: '<h2>Tall Wooden Buildings!</h2><p>Engineers figured out how to build skyscrapers from wood. Trees store carbon!</p>', MIDDLE_SCHOOL: '<h2>Mass Timber</h2><p>CLT (cross-laminated timber) panels are strong enough for tall buildings.</p>', HIGH_SCHOOL: '<h2>Timber Systems</h2><p>CLT, glulam, NLT - different mass timber products for different applications.</p>', UNDERGRADUATE: '<h2>Design Considerations</h2><p>Fire safety, connections, acoustics, and code requirements for mass timber.</p>', GRADUATE: '<h2>Carbon Storage</h2><p>Wood sequesters carbon, offering climate benefits versus concrete and steel.</p>', PHD: '<h2>Timber Research</h2><p>Fire performance, tall timber, and sustainable forest management.</p>' } }],
...
export const buildingEnergyModeling: Module = {
  ...
  description: { ELEMENTARY: 'Computer programs help design efficient buildings!', MIDDLE_SCHOOL: 'Learn how computers simulate building energy use.', HIGH_SCHOOL: 'Analyze energy modeling software, inputs, and outputs.', UNDERGRADUATE: 'Evaluate modeling methodology, calibration, and design optimization.', GRADUATE: 'Research uncertainty analysis, parametric studies, and advanced modeling.', PHD: 'Investigate model accuracy, calibration methods, and simulation research.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'modeling-1', title: 'Virtual Buildings', content: { ELEMENTARY: '<h2>Computer Building Design!</h2><p>Computers can test thousands of design options to find the most efficient building!</p>', MIDDLE_SCHOOL: '<h2>Energy Simulation</h2><p>Software predicts how much energy a building will use before it\'s built.</p>', HIGH_SCHOOL: '<h2>Modeling Basics</h2><p>Weather data, building geometry, systems, and schedules feed into simulations.</p>', UNDERGRADUATE: '<h2>Modeling Practice</h2><p>EnergyPlus, OpenStudio, and other tools for energy analysis.</p>', GRADUATE: '<h2>Advanced Modeling</h2><p>Parametric analysis, optimization algorithms, and uncertainty quantification.</p>', PHD: '<h2>Modeling Research</h2><p>Model accuracy, calibration to measured data, and emerging capabilities.</p>' } }],
  ...
  game: { id: 'modeling-game', title: 'Virtual Designer', type: 'simulation', description: 'Optimize buildings through simulation', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const regenerativeDesign: Module = {
  ...
  description: { ELEMENTARY: 'Buildings that help nature instead of hurting it!', MIDDLE_SCHOOL: 'Discover buildings that give back to the environment.', HIGH_SCHOOL: 'Analyze regenerative design principles and Living Building Challenge.', UNDERGRADUATE: 'Evaluate net positive design, ecosystem services, and restorative development.', GRADUATE: 'Research regenerative frameworks, place-based design, and whole systems.', PHD: 'Investigate regenerative theory, metrics, and transformation pathways.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'regen-1', title: 'Buildings That Give Back', content: { ELEMENTARY: '<h2>Helpful Buildings!</h2><p>Some buildings clean water, create habitat, and give more than they take!</p>', MIDDLE_SCHOOL: '<h2>Beyond Green</h2><p>Regenerative buildings restore ecosystems instead of just reducing harm.</p>', HIGH_SCHOOL: '<h2>Living Building Challenge</h2><p>The most ambitious standard: net positive energy, water, and materials.</p>', UNDERGRADUATE: '<h2>Net Positive</h2><p>Producing more energy, treating more water, and enhancing biodiversity.</p>', GRADUATE: '<h2>Regenerative Frameworks</h2><p>Place-based design, story of place, and whole systems thinking.</p>', PHD: '<h2>Regenerative Research</h2><p>Theory development, outcome measurement, and scaling approaches.</p>' } }],
  ...
  game: { id: 'regen-game', title: 'Living Building Creator', type: 'simulation', description: 'Create regenerative buildings', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const greenBuildingCareers: Module = {
  ...
  description: { ELEMENTARY: 'Jobs that help build a greener world!', MIDDLE_SCHOOL: 'Discover careers in sustainable building.', HIGH_SCHOOL: 'Explore professional paths in green building design and construction.', UNDERGRADUATE: 'Analyze credentials, skills, and career development in sustainable building.', GRADUATE: 'Research emerging roles, interdisciplinary skills, and leadership paths.', PHD: 'Investigate workforce development, research careers, and industry transformation.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'careers-1', title: 'Green Building Jobs', content: { ELEMENTARY: '<h2>Build a Green Future!</h2><p>Architects, engineers, and builders create sustainable buildings. You could too!</p>', MIDDLE_SCHOOL: '<h2>Career Options</h2><p>Sustainable architects, energy analysts, LEED consultants, and commissioning agents.</p>', HIGH_SCHOOL: '<h2>Education Paths</h2><p>Architecture, engineering, construction management, and sustainability programs.</p>', UNDERGRADUATE: '<h2>Credentials</h2><p>LEED AP, Passive House, WELL AP, and other professional certifications.</p>', GRADUATE: '<h2>Leadership Roles</h2><p>Sustainability directors, research scientists, and policy advocates.</p>', PHD: '<h2>Academic Careers</h2><p>Research faculty, industry research, and thought leadership.</p>' } }],
  ...
  game: { id: 'careers-game', title: 'Career Builder', type: 'simulation', description: 'Build your green building career', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
...
export const greenBuildingFuture: Module = {
  ...
  description: { ELEMENTARY: 'Imagine the amazing buildings of tomorrow!', MIDDLE_SCHOOL: 'Explore future innovations in sustainable building.', HIGH_SCHOOL: 'Analyze emerging technologies and trends in green building.', UNDERGRADUATE: 'Evaluate industry trajectories, disruptions, and future scenarios.', GRADUATE: 'Research transformation pathways and innovation systems.', PHD: 'Investigate building sector decarbonization and systemic change.' },
  topic: 'green-building',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'future-1', title: 'Tomorrow\'s Buildings', content: { ELEMENTARY: '<h2>Future Buildings!</h2><p>Buildings that grow, heal themselves, and work with nature - the future is exciting!</p>', MIDDLE_SCHOOL: '<h2>Emerging Tech</h2><p>3D printing, self-healing concrete, and smart materials are changing construction.</p>', HIGH_SCHOOL: '<h2>Innovation Trends</h2><p>Robotics, AI design, biomimicry, and circular construction.</p>', UNDERGRADUATE: '<h2>Industry Change</h2><p>Digitalization, prefabrication, and decarbonization transforming construction.</p>', GRADUATE: '<h2>Transformation</h2><p>Policy drivers, market forces, and pathways to sustainable building sector.</p>', PHD: '<h2>Future Research</h2><p>Grand challenges, moonshots, and transformative research agenda.</p>' } }],
  ...
  game: { id: 'future-game', title: 'Future Architect', type: 'simulation', description: 'Design buildings of the future', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: null, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 300, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 240, hints: false }, GRADUATE: { lives: 2, timeLimit: 180, hints: false }, PHD: { lives: 1, timeLimit: 120, hints: false } } },
