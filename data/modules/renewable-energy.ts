...
export const hydropowerBasics: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how flowing water makes electricity!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how dams and rivers generate clean power.', [LearningLevel.HIGH_SCHOOL]: 'Explore hydroelectric systems, turbine types, and dam engineering.', [LearningLevel.UNDERGRADUATE]: 'Analyze hydropower capacity factors, environmental impacts, and pumped storage.', [LearningLevel.GRADUATE]: 'Examine hydropower\'s role in grid flexibility and run-of-river systems.', [LearningLevel.PHD]: 'Research fish passage technologies, sediment management, and climate impacts.' },
  ...
  lessons: [{ id: 'hydro-1', title: 'Power of Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Water Power!</h2><p>Water flowing downhill can spin wheels to make electricity!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Hydroelectric Power</h2><p>Dams store water high up. When released, falling water spins turbines connected to generators.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Hydro Engineering</h2><p>Power = ρ × g × Q × H × η. Types: Pelton, Francis, Kaplan turbines for different head heights.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Analysis</h2><p>Capacity factor 30-50%. Pumped storage provides grid-scale energy storage.</p>', [LearningLevel.GRADUATE]: '<h2>Flexibility Services</h2><p>Hydro provides peaking power, frequency regulation, and spinning reserve.</p>', [LearningLevel.PHD]: '<h2>Environmental Research</h2><p>Fish passage, sediment continuity, and downstream temperature impacts.</p>' } }],
...
export const geothermalEnergy: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about heat energy from deep inside the Earth!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how we use Earth\'s internal heat for power and heating.', [LearningLevel.HIGH_SCHOOL]: 'Explore geothermal power plants, heat pumps, and resource assessment.', [LearningLevel.UNDERGRADUATE]: 'Analyze EGS systems, binary cycle plants, and resource sustainability.', [LearningLevel.GRADUATE]: 'Examine induced seismicity, reservoir engineering, and co-production.', [LearningLevel.PHD]: 'Research supercritical geothermal systems and advanced drilling technologies.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'geo-1', title: 'Earth\'s Heat', content: { [LearningLevel.ELEMENTARY]: '<h2>Hot Earth!</h2><p>Deep underground, Earth is very hot! We can use this heat to make electricity.</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Geothermal Basics</h2><p>Earth\'s core is 5,400°C! Hot water/steam from underground spins turbines.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Geothermal Plants</h2><p>Dry steam, flash steam, and binary cycle plants for different resource temperatures.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Enhanced Geothermal</h2><p>EGS creates reservoirs in hot dry rock. Binary plants work with lower temps (100-180°C).</p>', [LearningLevel.GRADUATE]: '<h2>Reservoir Engineering</h2><p>Sustainable extraction rates, reinjection strategies, induced seismicity management.</p>', [LearningLevel.PHD]: '<h2>Supercritical Systems</h2><p>Accessing supercritical fluids (>374°C) for dramatically higher power output.</p>' } }],
  ...
  game: { id: 'geo-game', title: 'Geothermal Driller', type: 'simulation', description: 'Find and tap geothermal resources', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const biomassEnergy: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how plants and waste can make energy!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how organic matter becomes fuel and electricity.', [LearningLevel.HIGH_SCHOOL]: 'Explore biofuels, biogas, and biomass power generation.', [LearningLevel.UNDERGRADUATE]: 'Analyze lifecycle emissions, land use, and sustainability of bioenergy.', [LearningLevel.GRADUATE]: 'Examine BECCS, advanced biofuels, and bioenergy policy debates.', [LearningLevel.PHD]: 'Research cellulosic conversion, algae systems, and carbon accounting.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'bio-1', title: 'Energy from Plants', content: { [LearningLevel.ELEMENTARY]: '<h2>Plant Power!</h2><p>Plants store sunshine as energy. We can burn plants or turn them into fuel!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Biomass Basics</h2><p>Wood, crops, waste → direct burning, biogas, or biofuels like ethanol and biodiesel.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Bioenergy Pathways</h2><p>Combustion, gasification, anaerobic digestion, fermentation, transesterification.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Sustainability Analysis</h2><p>Land use change emissions can negate benefits. Sustainable sourcing critical.</p>', [LearningLevel.GRADUATE]: '<h2>BECCS</h2><p>Bioenergy with carbon capture potentially carbon-negative, but scalability debated.</p>', [LearningLevel.PHD]: '<h2>Advanced Biofuels</h2><p>Cellulosic ethanol, algal biodiesel, synthetic biology approaches.</p>' } }],
  ...
  game: { id: 'bio-game', title: 'Biofuel Creator', type: 'simulation', description: 'Convert biomass to energy', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const oceanEnergy: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how ocean waves and tides can make electricity!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover wave energy converters and tidal power systems.', [LearningLevel.HIGH_SCHOOL]: 'Explore tidal barrages, stream turbines, and wave energy technologies.', [LearningLevel.UNDERGRADUATE]: 'Analyze ocean thermal, salinity gradient, and marine energy economics.', [LearningLevel.GRADUATE]: 'Examine array effects, environmental impacts, and grid integration.', [LearningLevel.PHD]: 'Research survivability, power take-off systems, and resource assessment.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'ocean-1', title: 'Power from the Sea', content: { [LearningLevel.ELEMENTARY]: '<h2>Wave Power!</h2><p>Ocean waves go up and down. We can use this motion to make electricity!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Ocean Energy Types</h2><p>Wave energy, tidal energy, ocean thermal (OTEC), and salinity gradient.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Tidal Systems</h2><p>Tidal barrages: predictable but high impact. Tidal stream: like underwater wind turbines.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Wave Technologies</h2><p>Oscillating water column, point absorbers, attenuators, overtopping devices.</p>', [LearningLevel.GRADUATE]: '<h2>Array Optimization</h2><p>Hydrodynamic interactions, cable routing, O&M strategies in harsh environments.</p>', [LearningLevel.PHD]: '<h2>Survivability Research</h2><p>Designing for extreme waves, biofouling, corrosion in marine environment.</p>' } }],
  ...
  game: { id: 'ocean-game', title: 'Tidal Engineer', type: 'simulation', description: 'Harness the power of tides', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const energyStorageFundamentals: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how we save energy for later, like a battery!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover different ways to store electricity for when we need it.', [LearningLevel.HIGH_SCHOOL]: 'Explore batteries, pumped hydro, and other storage technologies.', [LearningLevel.UNDERGRADUATE]: 'Analyze storage economics, sizing, and grid services.', [LearningLevel.GRADUATE]: 'Examine long-duration storage, market design, and policy frameworks.', [LearningLevel.PHD]: 'Research novel storage chemistries, aging mechanisms, and system optimization.' },
  topic: 'renewable-energy',
  ...
  lessons: [{ id: 'storage-1', title: 'Saving Power', content: { [LearningLevel.ELEMENTARY]: '<h2>Energy Piggy Bank!</h2><p>Batteries store electricity like a piggy bank stores coins. Use it later when you need it!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Why Storage Matters</h2><p>Sun shines by day, wind blows unpredictably. Storage fills gaps between generation and demand.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Storage Technologies</h2><p>Lithium-ion (80% market), flow batteries, pumped hydro (95% of installed storage).</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Storage Economics</h2><p>LCOS (levelized cost of storage), revenue stacking from multiple services.</p>', [LearningLevel.GRADUATE]: '<h2>Long-Duration Storage</h2><p>Beyond 4-hour Li-ion: iron-air, hydrogen, compressed air for seasonal shifting.</p>', [LearningLevel.PHD]: '<h2>Degradation Science</h2><p>Calendar and cycle aging, capacity fade mechanisms, second-life applications.</p>' } }],
  ...
  game: { id: 'storage-game', title: 'Grid Balancer', type: 'simulation', description: 'Use storage to balance the grid', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const solarThermalSystems: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how sunshine can heat water for your home!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how solar collectors capture heat for hot water and buildings.', [LearningLevel.HIGH_SCHOOL]: 'Explore concentrating solar power (CSP) and solar water heating systems.', [LearningLevel.UNDERGRADUATE]: 'Analyze thermal storage, hybrid systems, and industrial process heat.', [LearningLevel.GRADUATE]: 'Examine CSP dispatch strategies, molten salt storage, and grid integration.', [LearningLevel.PHD]: 'Research high-temperature receivers, thermochemical cycles, and solar fuels.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'thermal-1', title: 'Heat from Sun', content: { [LearningLevel.ELEMENTARY]: '<h2>Solar Hot Water!</h2><p>Dark panels on roofs absorb sunshine and heat water for showers and dishes!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Solar Thermal Basics</h2><p>Flat plate collectors heat water directly. Evacuated tubes work even in cold weather.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>CSP Technology</h2><p>Parabolic troughs, power towers, dish systems concentrate sunlight to generate steam.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Thermal Storage</h2><p>Molten salt stores heat for hours. Enables CSP to generate power after sunset.</p>', [LearningLevel.GRADUATE]: '<h2>Hybrid Systems</h2><p>CSP + PV, CSP + natural gas for dispatchable solar electricity.</p>', [LearningLevel.PHD]: '<h2>High-Temperature Applications</h2><p>Solar thermochemistry for hydrogen production and industrial decarbonization.</p>' } }],
  ...
  game: { id: 'thermal-game', title: 'Sun Catcher', type: 'simulation', description: 'Concentrate solar heat', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const smallScaleWind: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about small wind turbines for homes and farms!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how small wind turbines can power individual properties.', [LearningLevel.HIGH_SCHOOL]: 'Explore residential wind turbine design, siting, and economics.', [LearningLevel.UNDERGRADUATE]: 'Analyze micro-wind resource assessment and hybrid system design.', [LearningLevel.GRADUATE]: 'Examine urban wind, building-integrated systems, and policy barriers.', [LearningLevel.PHD]: 'Research vertical axis turbines, diffuser augmentation, and low-wind designs.' },
  topic: 'renewable-energy',
  ...
  lessons: [{ id: 'small-wind-1', title: 'Wind at Home', content: { [LearningLevel.ELEMENTARY]: '<h2>Backyard Wind!</h2><p>Small wind turbines can power your house if you live somewhere windy!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Small Wind Systems</h2><p>Typically 1-10 kW. Need average winds >5 m/s. Tower height matters!</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Site Assessment</h2><p>Wind maps, anemometer data, obstacle analysis. Power ∝ v³ makes site crucial.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Design</h2><p>Tower height optimization, battery vs grid-tied, hybrid with solar.</p>', [LearningLevel.GRADUATE]: '<h2>Urban Challenges</h2><p>Turbulence from buildings, noise concerns, aesthetic objections.</p>', [LearningLevel.PHD]: '<h2>Novel Designs</h2><p>VAWT advantages in turbulent flow, shrouded turbines, building integration.</p>' } }],
  ...
  game: { id: 'small-wind-game', title: 'Wind Scout', type: 'simulation', description: 'Find the best wind site', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const microgrids: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about small power systems that work on their own!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how local energy systems can power communities independently.', [LearningLevel.HIGH_SCHOOL]: 'Explore microgrid architecture, islanding, and resilience benefits.', [LearningLevel.UNDERGRADUATE]: 'Analyze microgrid control strategies, protection schemes, and economics.', [LearningLevel.GRADUATE]: 'Examine networked microgrids, transactive energy, and regulatory frameworks.', [LearningLevel.PHD]: 'Research multi-agent control, blockchain integration, and optimal sizing.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'micro-1', title: 'Local Power', content: { [LearningLevel.ELEMENTARY]: '<h2>Neighborhood Power!</h2><p>A microgrid is like having your own small power station for your neighborhood!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>What is a Microgrid?</h2><p>Local generation + storage + loads. Can disconnect from main grid during outages.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Microgrid Benefits</h2><p>Resilience, renewable integration, reduced losses, energy independence.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Control Architecture</h2><p>Hierarchical control: primary (droop), secondary (restoration), tertiary (optimization).</p>', [LearningLevel.GRADUATE]: '<h2>Networked Microgrids</h2><p>Multiple microgrids trading energy, mutual support during emergencies.</p>', [LearningLevel.PHD]: '<h2>Advanced Control</h2><p>Multi-agent systems, distributed optimization, cyber-physical security.</p>' } }],
  ...
  game: { id: 'micro-game', title: 'Grid Manager', type: 'simulation', description: 'Keep your microgrid running', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const gridIntegration: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how renewable energy connects to our power grid!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how solar and wind are added to the electricity network.', [LearningLevel.HIGH_SCHOOL]: 'Explore inverter technology, interconnection, and grid stability.', [LearningLevel.UNDERGRADUATE]: 'Analyze power electronics, grid codes, and ancillary services.', [LearningLevel.GRADUATE]: 'Examine high-penetration challenges, flexibility options, and market design.', [LearningLevel.PHD]: 'Research grid-forming inverters, synthetic inertia, and 100% inverter-based grids.' },
  topic: 'renewable-energy',
  ...
  lessons: [{ id: 'grid-1', title: 'Connecting Clean Power', content: { [LearningLevel.ELEMENTARY]: '<h2>Power Network!</h2><p>The grid is like a highway for electricity. Renewable power joins in!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>How Renewables Connect</h2><p>Inverters convert DC to AC. Must match grid frequency (50/60 Hz) and voltage.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Grid Challenges</h2><p>Variability, ramp rates, voltage regulation, frequency stability.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Ancillary Services</h2><p>Frequency regulation, voltage support, spinning reserve from renewables + storage.</p>', [LearningLevel.GRADUATE]: '<h2>High Penetration</h2><p>Duck curve, curtailment, negative prices, flexibility requirements.</p>', [LearningLevel.PHD]: '<h2>Grid-Forming Inverters</h2><p>Black start capability, synthetic inertia, stable 100% IBR grids.</p>' } }],
  ...
  game: { id: 'grid-game', title: 'Grid Operator', type: 'simulation', description: 'Keep frequency stable', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const energyEfficiency: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how to use less energy while still having fun!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover ways to save energy at home and school.', [LearningLevel.HIGH_SCHOOL]: 'Explore energy auditing, appliance efficiency, and building performance.', [LearningLevel.UNDERGRADUATE]: 'Analyze demand-side management, ESCO models, and policy mechanisms.', [LearningLevel.GRADUATE]: 'Examine rebound effects, behavioral economics, and efficiency standards.', [LearningLevel.PHD]: 'Research energy-GDP decoupling, efficiency frontiers, and sufficiency debates.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'eff-1', title: 'Save Energy', content: { [LearningLevel.ELEMENTARY]: '<h2>Energy Detective!</h2><p>Turn off lights, unplug chargers, use less hot water. Small actions add up!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Efficiency Basics</h2><p>LED lights use 75% less energy. Efficient appliances have ENERGY STAR labels.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Energy Auditing</h2><p>Thermal imaging, blower door tests, utility bill analysis identify savings.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>DSM Programs</h2><p>Utility rebates, time-of-use rates, demand response programs.</p>', [LearningLevel.GRADUATE]: '<h2>Rebound Effects</h2><p>Efficiency savings partly offset by increased consumption. Policy implications.</p>', [LearningLevel.PHD]: '<h2>Sufficiency</h2><p>Beyond efficiency: questioning energy service demands and absolute consumption.</p>' } }],
  ...
  game: { id: 'eff-game', title: 'Efficiency Hunter', type: 'puzzle', description: 'Find and fix energy waste', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const communityEnergy: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how neighborhoods can make clean energy together!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how communities own and share renewable energy projects.', [LearningLevel.HIGH_SCHOOL]: 'Explore community solar, wind cooperatives, and shared ownership models.', [LearningLevel.UNDERGRADUATE]: 'Analyze community energy business models, financing, and social benefits.', [LearningLevel.GRADUATE]: 'Examine energy democracy, cooperative structures, and equity considerations.', [LearningLevel.PHD]: 'Research community energy as sociotechnical transition and grassroots innovation.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'comm-1', title: 'Power Together', content: { [LearningLevel.ELEMENTARY]: '<h2>Neighbors Sharing Power!</h2><p>A whole neighborhood can share a big solar project!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Community Models</h2><p>Community solar lets renters participate. Wind co-ops share ownership and profits.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Ownership Structures</h2><p>Cooperatives, community benefit societies, municipal utilities, shared ownership.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Business Models</h2><p>Subscription vs ownership. Third-party vs community-led. Virtual net metering.</p>', [LearningLevel.GRADUATE]: '<h2>Energy Democracy</h2><p>Community ownership challenges incumbent utility model. Distributes benefits locally.</p>', [LearningLevel.PHD]: '<h2>Grassroots Innovation</h2><p>Community energy as niche innovation. Scaling challenges and mainstream integration.</p>' } }],
  ...
  game: { id: 'comm-game', title: 'Community Organizer', type: 'simulation', description: 'Build community energy support', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const carbonFootprintClimate: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how clean energy helps stop climate change!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how renewable energy reduces greenhouse gas emissions.', [LearningLevel.HIGH_SCHOOL]: 'Explore lifecycle carbon analysis and climate mitigation through renewables.', [LearningLevel.UNDERGRADUATE]: 'Analyze embodied carbon, scope emissions, and renewable\'s role in decarbonization.', [LearningLevel.GRADUATE]: 'Examine carbon accounting frameworks, net-zero pathways, and remaining emissions.', [LearningLevel.PHD]: 'Research carbon budgets, negative emissions, and integrated assessment modeling.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'carbon-1', title: 'Clean vs Dirty Energy', content: { [LearningLevel.ELEMENTARY]: '<h2>Saving the Planet!</h2><p>Coal and gas make pollution. Solar and wind are clean!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Carbon Emissions</h2><p>Burning fossil fuels releases CO2. Renewable generation is nearly carbon-free.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Lifecycle Analysis</h2><p>Solar: ~20-50 gCO2/kWh. Coal: ~800-1200 gCO2/kWh. Include manufacturing.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Scope Emissions</h2><p>Scope 1: direct. Scope 2: purchased electricity. Scope 3: supply chain.</p>', [LearningLevel.GRADUATE]: '<h2>Net-Zero Pathways</h2><p>Electricity first, then heat, transport. Residual emissions need removal.</p>', [LearningLevel.PHD]: '<h2>Carbon Budgets</h2><p>IPCC remaining budget for 1.5°C. Implications for renewable deployment rates.</p>' } }],
  ...
  game: { id: 'carbon-game', title: 'Carbon Cutter', type: 'puzzle', description: 'Reduce emissions with renewables', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const renewableEnergyCareers: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about cool jobs working with clean energy!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover careers in the growing renewable energy industry.', [LearningLevel.HIGH_SCHOOL]: 'Explore education pathways and job opportunities in renewables.', [LearningLevel.UNDERGRADUATE]: 'Analyze renewable energy job markets, skills, and career planning.', [LearningLevel.GRADUATE]: 'Examine workforce development, just transition, and labor market dynamics.', [LearningLevel.PHD]: 'Research green jobs, skill gaps, and socioeconomic transition impacts.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 15, [LearningLevel.MIDDLE_SCHOOL]: 25, [LearningLevel.HIGH_SCHOOL]: 40, [LearningLevel.UNDERGRADUATE]: 60, [LearningLevel.GRADUATE]: 85, [LearningLevel.PHD]: 110 },
  lessons: [{ id: 'career-1', title: 'Green Jobs', content: { [LearningLevel.ELEMENTARY]: '<h2>Energy Heroes!</h2><p>Solar installers, wind technicians, and engineers build our clean energy future!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Career Options</h2><p>Solar installer, wind turbine tech, electrical engineer, energy auditor, project manager.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Pathways</h2><p>Trade school, community college, university degrees. Apprenticeships available.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Job Market</h2><p>Solar installer is fastest-growing US occupation. Median wages, job projections.</p>', [LearningLevel.GRADUATE]: '<h2>Just Transition</h2><p>Retraining fossil fuel workers. Geographic distribution of new jobs.</p>', [LearningLevel.PHD]: '<h2>Workforce Research</h2><p>Skills taxonomy, labor market modeling, equity in green job access.</p>' } }],
  ...
  game: { id: 'career-game', title: 'Career Builder', type: 'puzzle', description: 'Match skills to careers', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const passiveSolarDesign: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how buildings can use sunshine without any machines!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how building design captures free heat and light from the sun.', [LearningLevel.HIGH_SCHOOL]: 'Explore passive solar heating, daylighting, and thermal mass principles.', [LearningLevel.UNDERGRADUATE]: 'Analyze passive solar design strategies, climate considerations, and performance.', [LearningLevel.GRADUATE]: 'Examine advanced passive techniques, retrofit strategies, and design optimization.', [LearningLevel.PHD]: 'Research adaptive facades, predictive control, and climate-responsive design.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'passive-1', title: 'Free Solar Heat', content: { [LearningLevel.ELEMENTARY]: '<h2>Smart Buildings!</h2><p>Big south windows let sunshine warm the house for free!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Passive Solar Basics</h2><p>South-facing windows, thermal mass (concrete/tile), overhangs for summer shade.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Design Elements</h2><p>Aperture (windows), absorber, thermal mass, distribution, control (overhangs, vents).</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Climate Adaptation</h2><p>Different strategies for heating vs cooling climates. Glass-to-mass ratios.</p>', [LearningLevel.GRADUATE]: '<h2>Advanced Techniques</h2><p>Trombe walls, sunspaces, earth tubes, phase change materials.</p>', [LearningLevel.PHD]: '<h2>Adaptive Systems</h2><p>Electrochromic glazing, automated shading, model predictive control.</p>' } }],
  ...
  game: { id: 'passive-game', title: 'Sun Architect', type: 'puzzle', description: 'Design an efficient building', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const netZeroBuildings: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about buildings that make as much energy as they use!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how buildings can produce all their own energy.', [LearningLevel.HIGH_SCHOOL]: 'Explore net-zero energy building design and verification.', [LearningLevel.UNDERGRADUATE]: 'Analyze net-zero strategies, costs, and certification systems.', [LearningLevel.GRADUATE]: 'Examine net-zero districts, grid interactions, and policy frameworks.', [LearningLevel.PHD]: 'Research zero-carbon buildings, embodied carbon, and whole-life carbon approaches.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'netzero-1', title: 'Zero Energy', content: { [LearningLevel.ELEMENTARY]: '<h2>Energy Balance!</h2><p>Some buildings make ALL the energy they need with solar panels!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Net-Zero Concept</h2><p>Reduce energy use first (efficiency), then generate the rest with renewables on site.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Net-Zero Design</h2><p>Super-insulation, air sealing, efficient systems, right-sized solar. Annual energy balance.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Definitions</h2><p>Net-zero site energy, source energy, cost, emissions. Different accounting methods.</p>', [LearningLevel.GRADUATE]: '<h2>District Scale</h2><p>Net-zero neighborhoods and campuses. Shared resources, load diversity benefits.</p>', [LearningLevel.PHD]: '<h2>Whole-Life Carbon</h2><p>Embodied carbon often rivals operational. Lifecycle approaches needed.</p>' } }],
  ...
  game: { id: 'netzero-game', title: 'Zero Builder', type: 'simulation', description: 'Achieve net-zero energy', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const smartGridSystems: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how computers help manage our electricity!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how smart technology makes the power grid work better.', [LearningLevel.HIGH_SCHOOL]: 'Explore smart meters, demand response, and grid automation.', [LearningLevel.UNDERGRADUATE]: 'Analyze smart grid architecture, communications, and cybersecurity.', [LearningLevel.GRADUATE]: 'Examine distribution automation, DER management, and market platforms.', [LearningLevel.PHD]: 'Research transactive energy, grid-edge intelligence, and emergent behavior.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'smart-1', title: 'Intelligent Grids', content: { [LearningLevel.ELEMENTARY]: '<h2>Smart Electricity!</h2><p>Smart grids use computers to make sure electricity goes where it\'s needed!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Smart Grid Basics</h2><p>Two-way communication, smart meters, automatic fault detection, demand response.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Smart Technologies</h2><p>AMI, SCADA, distribution automation, phasor measurement units, DERMS.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Communication Layers</h2><p>HAN, NAN, WAN. Standards: IEEE 2030, IEC 61850. Cybersecurity challenges.</p>', [LearningLevel.GRADUATE]: '<h2>DER Integration</h2><p>Distributed energy resource management systems. Aggregation and virtual power plants.</p>', [LearningLevel.PHD]: '<h2>Transactive Energy</h2><p>Market-based coordination of distributed resources. Emergent grid behavior.</p>' } }],
...
export const batteryTechnology: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how batteries store electricity for later!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how different batteries work for renewable energy storage.', [LearningLevel.HIGH_SCHOOL]: 'Explore battery chemistry, performance, and applications.', [LearningLevel.UNDERGRADUATE]: 'Analyze battery systems, BMS design, and degradation mechanisms.', [LearningLevel.GRADUATE]: 'Examine advanced chemistries, safety, and recycling challenges.', [LearningLevel.PHD]: 'Research solid-state, metal-air, and beyond lithium technologies.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 55, [LearningLevel.UNDERGRADUATE]: 75, [LearningLevel.GRADUATE]: 100, [LearningLevel.PHD]: 130 },
  lessons: [{ id: 'battery-1', title: 'Storing Power', content: { [LearningLevel.ELEMENTARY]: '<h2>Electricity Banks!</h2><p>Batteries store electricity like a piggy bank stores money - for when you need it!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Battery Types</h2><p>Lithium-ion most common. Flow batteries for long duration. Lead-acid still used in some applications.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Battery Chemistry</h2><p>Anode, cathode, electrolyte. Li-ion: LFP vs NMC. Energy vs power density tradeoffs.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Design</h2><p>Battery management systems, thermal management, cell balancing, state estimation.</p>', [LearningLevel.GRADUATE]: '<h2>Degradation</h2><p>Calendar and cycle aging. SEI growth, lithium plating, capacity fade mechanisms.</p>', [LearningLevel.PHD]: '<h2>Next Generation</h2><p>Solid-state, lithium-sulfur, sodium-ion, iron-air. Materials research frontiers.</p>' } }],
...
export const solarInstallationMaintenance: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how workers put solar panels on roofs!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how solar systems are installed and maintained.', [LearningLevel.HIGH_SCHOOL]: 'Explore installation best practices, codes, and O&M procedures.', [LearningLevel.UNDERGRADUATE]: 'Analyze commissioning, performance monitoring, and troubleshooting.', [LearningLevel.GRADUATE]: 'Examine fleet management, predictive maintenance, and repowering.', [LearningLevel.PHD]: 'Research degradation analytics, reliability modeling, and O&M optimization.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'install-1', title: 'Installing Solar', content: { [LearningLevel.ELEMENTARY]: '<h2>Solar Workers!</h2><p>Trained workers safely install solar panels on rooftops!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Installation Steps</h2><p>Site survey, permits, mounting rails, panels, wiring, inverter, inspection.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Codes & Safety</h2><p>NEC requirements, rapid shutdown, grounding, fire setbacks, electrical permits.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Commissioning</h2><p>I-V curve tracing, thermal imaging, performance verification, monitoring setup.</p>', [LearningLevel.GRADUATE]: '<h2>O&M Programs</h2><p>Preventive vs corrective maintenance. Fleet analytics and benchmarking.</p>', [LearningLevel.PHD]: '<h2>Performance Analytics</h2><p>Machine learning for fault detection. Degradation modeling and prediction.</p>' } }],
  ...
  game: { id: 'install-game', title: 'Solar Installer', type: 'simulation', description: 'Install a solar system safely', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const windFarmDesign: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how wind farms are planned and built!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover what goes into building a wind farm.', [LearningLevel.HIGH_SCHOOL]: 'Explore wind resource assessment, layout design, and environmental review.', [LearningLevel.UNDERGRADUATE]: 'Analyze wind farm optimization, wake effects, and project development.', [LearningLevel.GRADUATE]: 'Examine offshore design, foundation types, and transmission planning.', [LearningLevel.PHD]: 'Research wind farm control, data-driven optimization, and hybrid plants.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 55, [LearningLevel.UNDERGRADUATE]: 75, [LearningLevel.GRADUATE]: 100, [LearningLevel.PHD]: 130 },
  lessons: [{ id: 'windfarm-1', title: 'Building Wind Farms', content: { [LearningLevel.ELEMENTARY]: '<h2>Wind Power Places!</h2><p>Engineers pick windy spots and plan where to put each turbine!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Wind Farm Planning</h2><p>Measure wind for 1-2 years. Check environmental impacts. Design turbine layout.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Site Development</h2><p>Met masts, Lidar, wind resource analysis. Noise setbacks, bird/bat studies.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Layout Optimization</h2><p>Wake effects reduce output 10-20%. Spacing, staggered rows, wind rose analysis.</p>', [LearningLevel.GRADUATE]: '<h2>Offshore Challenges</h2><p>Monopile, jacket, floating foundations. Submarine cables, O&M logistics.</p>', [LearningLevel.PHD]: '<h2>Advanced Control</h2><p>Wake steering, dynamic yaw control, coordinated operation for load reduction.</p>' } }],
  ...
  game: { id: 'windfarm-game', title: 'Wind Farm Planner', type: 'simulation', description: 'Build an efficient wind farm', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const industrialDecarbonization: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how factories can use clean energy too!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how industries are switching to renewable energy.', [LearningLevel.HIGH_SCHOOL]: 'Explore industrial energy use, efficiency, and electrification.', [LearningLevel.UNDERGRADUATE]: 'Analyze industrial heat, process emissions, and decarbonization pathways.', [LearningLevel.GRADUATE]: 'Examine steel, cement, chemicals and hard-to-abate sector strategies.', [LearningLevel.PHD]: 'Research breakthrough technologies, CCUS, and industrial ecosystem transformation.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 35, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'ind-1', title: 'Clean Factories', content: { [LearningLevel.ELEMENTARY]: '<h2>Green Factories!</h2><p>Factories can use solar, wind, and other clean energy instead of burning fuels!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Industrial Energy</h2><p>Factories use lots of energy for heat and machines. Many are switching to renewables.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Decarbonization Options</h2><p>Energy efficiency, electrification, green hydrogen, sustainable fuels.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Process Heat</h2><p>Low (<150°C), medium (150-400°C), high (>400°C) temp heat have different solutions.</p>', [LearningLevel.GRADUATE]: '<h2>Hard-to-Abate Sectors</h2><p>Steel: hydrogen-DRI. Cement: carbon capture. Chemicals: electrification + feedstock.</p>', [LearningLevel.PHD]: '<h2>Industrial Ecosystems</h2><p>Industrial symbiosis, circular economy, system-level optimization approaches.</p>' } }],
  ...
  game: { id: 'ind-game', title: 'Factory Transformer', type: 'simulation', description: 'Make industry carbon-free', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const sustainableTransportation: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about clean ways to travel - bikes, buses, and electric cars!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how transportation can be powered by renewable energy.', [LearningLevel.HIGH_SCHOOL]: 'Explore electric vehicles, public transit, and transportation emissions.', [LearningLevel.UNDERGRADUATE]: 'Analyze transport decarbonization pathways, mode shift, and infrastructure.', [LearningLevel.GRADUATE]: 'Examine aviation, shipping, and long-distance transport challenges.', [LearningLevel.PHD]: 'Research transport system transformation, behavior change, and policy integration.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'trans-1', title: 'Clean Travel', content: { [LearningLevel.ELEMENTARY]: '<h2>Green Ways to Go!</h2><p>Walking, biking, buses, and trains are cleaner than driving alone!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Transport Options</h2><p>Electric cars, e-bikes, public transit, walking, biking all reduce emissions.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Transport Emissions</h2><p>Transport is ~25% of global CO2. Light-duty EVs, heavy-duty challenges.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Decarbonization Pathways</h2><p>Avoid (reduce travel), shift (to clean modes), improve (efficiency and fuels).</p>', [LearningLevel.GRADUATE]: '<h2>Hard-to-Abate Transport</h2><p>Aviation: SAFs, hydrogen. Shipping: ammonia, methanol. Long-haul trucks: hydrogen.</p>', [LearningLevel.PHD]: '<h2>System Transformation</h2><p>Urban planning integration, shared mobility, autonomous vehicles, behavior change.</p>' } }],
  ...
  game: { id: 'trans-game', title: 'Transport Planner', type: 'simulation', description: 'Decarbonize transportation', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const energyEconomics: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how much clean energy costs and saves!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover why solar and wind are becoming cheaper than fossil fuels.', [LearningLevel.HIGH_SCHOOL]: 'Explore levelized cost of energy, payback periods, and energy markets.', [LearningLevel.UNDERGRADUATE]: 'Analyze LCOE, capacity factors, learning curves, and investment analysis.', [LearningLevel.GRADUATE]: 'Examine electricity market design, wholesale pricing, and investment risk.', [LearningLevel.PHD]: 'Research energy system modeling, optimal investment, and transition economics.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 50, [LearningLevel.UNDERGRADUATE]: 70, [LearningLevel.GRADUATE]: 95, [LearningLevel.PHD]: 125 },
  lessons: [{ id: 'econ-1', title: 'Energy Costs', content: { [LearningLevel.ELEMENTARY]: '<h2>Clean Energy Deals!</h2><p>Solar and wind are now cheaper than burning coal and gas!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Cost Comparison</h2><p>Solar costs fell 89% since 2010. Wind fell 70%. Now cheapest new electricity.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>LCOE</h2><p>Levelized Cost of Energy = total costs / total energy over project lifetime.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Investment Analysis</h2><p>NPV, IRR, payback period, capacity factor, discount rate, PPA structures.</p>', [LearningLevel.GRADUATE]: '<h2>Market Design</h2><p>Energy markets, capacity markets, ancillary services. Revenue stacking.</p>', [LearningLevel.PHD]: '<h2>Transition Economics</h2><p>Stranded assets, optimal phase-out, carbon pricing, green finance.</p>' } }],
  ...
  game: { id: 'econ-game', title: 'Energy Investor', type: 'simulation', description: 'Build a profitable clean energy portfolio', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const agrivoltaics: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn how solar panels and farms can share the same land!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how solar panels can be combined with farming.', [LearningLevel.HIGH_SCHOOL]: 'Explore dual-use solar installations for agriculture and energy.', [LearningLevel.UNDERGRADUATE]: 'Analyze agrivoltaic system design, crop selection, and yield impacts.', [LearningLevel.GRADUATE]: 'Examine water savings, microclimate effects, and economic models.', [LearningLevel.PHD]: 'Research optimal configurations, ecosystem services, and land use policy.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'agri-1', title: 'Solar + Farming', content: { [LearningLevel.ELEMENTARY]: '<h2>Farm Under Panels!</h2><p>Crops can grow under solar panels, getting shade and rain!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Agrivoltaics</h2><p>Solar panels over crops provide shade, reduce water needs, and make electricity!</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>System Design</h2><p>Elevated panels for equipment access. Crop selection matters - shade-tolerant best.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Yield Effects</h2><p>Some crops yield more under panels (lettuce, tomatoes). Reduced water evaporation.</p>', [LearningLevel.GRADUATE]: '<h2>Economic Models</h2><p>Dual revenue streams. Higher installation cost vs. higher total land productivity.</p>', [LearningLevel.PHD]: '<h2>Optimization Research</h2><p>Panel spacing, height, transparency. Crop-specific microclimate modeling.</p>' } }],
  ...
  game: { id: 'agri-game', title: 'Solar Farmer', type: 'simulation', description: 'Run an agrivoltaic farm', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const floatingSolar: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Learn about solar panels that float on water!', [LearningLevel.MIDDLE_SCHOOL]: 'Discover how solar panels can be installed on lakes and reservoirs.', [LearningLevel.HIGH_SCHOOL]: 'Explore floating PV system design, benefits, and applications.', [LearningLevel.UNDERGRADUATE]: 'Analyze floating solar economics, performance, and environmental impacts.', [LearningLevel.GRADUATE]: 'Examine offshore floating solar, hybrid hydro-solar, and system optimization.', [LearningLevel.PHD]: 'Research wave loading, degradation in marine environments, and ecosystem effects.' },
  topic: 'renewable-energy',
  estimatedMinutes: { [LearningLevel.ELEMENTARY]: 20, [LearningLevel.MIDDLE_SCHOOL]: 30, [LearningLevel.HIGH_SCHOOL]: 45, [LearningLevel.UNDERGRADUATE]: 65, [LearningLevel.GRADUATE]: 90, [LearningLevel.PHD]: 120 },
  lessons: [{ id: 'float-1', title: 'Solar on Water', content: { [LearningLevel.ELEMENTARY]: '<h2>Floating Panels!</h2><p>Solar panels on big floats can make electricity from lakes!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Floating PV</h2><p>Panels on pontoons float on reservoirs. Saves land, cools panels for better efficiency.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>Floating Solar Benefits</h2><p>No land needed, water cooling boosts output ~5%, reduces evaporation from reservoirs.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>System Design</h2><p>HDPE floats, anchoring systems, cable management, inverter platforms.</p>', [LearningLevel.GRADUATE]: '<h2>Hydro-Solar Hybrid</h2><p>Combine with hydropower for complementary generation and shared infrastructure.</p>', [LearningLevel.PHD]: '<h2>Marine Applications</h2><p>Offshore floating solar. Wave loading, corrosion, marine growth challenges.</p>' } }],
  ...
  game: { id: 'float-game', title: 'Float Builder', type: 'simulation', description: 'Build floating solar arrays', difficulty: { [LearningLevel.ELEMENTARY]: { lives: 5, timeLimit: null, hints: true }, [LearningLevel.MIDDLE_SCHOOL]: { lives: 4, timeLimit: 300, hints: true }, [LearningLevel.HIGH_SCHOOL]: { lives: 3, timeLimit: 240, hints: false }, [LearningLevel.UNDERGRADUATE]: { lives: 3, timeLimit: 180, hints: false }, [LearningLevel.GRADUATE]: { lives: 2, timeLimit: 120, hints: false }, [LearningLevel.PHD]: { lives: 1, timeLimit: 90, hints: false } } },
...
export const renewableEnergyMasterclassModule: Module = {
  ...
  description: { [LearningLevel.ELEMENTARY]: 'Become a renewable energy expert by combining everything you learned!', [LearningLevel.MIDDLE_SCHOOL]: 'Master the complete picture of renewable energy systems.', [LearningLevel.HIGH_SCHOOL]: 'Synthesize renewable energy concepts into comprehensive understanding.', [LearningLevel.UNDERGRADUATE]: 'Integrate technical, economic, and policy aspects of energy transition.', [LearningLevel.GRADUATE]: 'Develop advanced strategies for 100% renewable energy systems.', [LearningLevel.PHD]: 'Conduct original research on energy system transformation pathways.' },
  topic: 'renewable-energy',
  ...
  lessons: [{ id: 'master-1', title: 'Energy Integration', content: { [LearningLevel.ELEMENTARY]: '<h2>Energy Expert!</h2><p>You now know about sun, wind, water, and earth power. Together they can power everything!</p>', [LearningLevel.MIDDLE_SCHOOL]: '<h2>Putting It Together</h2><p>Combine solar + wind + storage + efficiency for reliable clean energy anywhere.</p>', [LearningLevel.HIGH_SCHOOL]: '<h2>System Thinking</h2><p>Generation, storage, transmission, distribution, demand. All must work together.</p>', [LearningLevel.UNDERGRADUATE]: '<h2>Transition Pathways</h2><p>From 30% to 100% renewables. Flexibility, storage, interconnection, demand response.</p>', [LearningLevel.GRADUATE]: '<h2>100% RE Systems</h2><p>Sector coupling, seasonal storage, long-distance transmission, demand flexibility.</p>', [LearningLevel.PHD]: '<h2>Research Frontiers</h2><p>Ultra-high RE penetration, negative emissions, social dimensions, just transition.</p>' } }],
