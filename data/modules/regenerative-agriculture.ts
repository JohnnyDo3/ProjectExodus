...
export const coverCrops: Module = {
  ...
  description: { ELEMENTARY: 'Learn about plants that protect the soil like a blanket!', MIDDLE_SCHOOL: 'Discover how farmers grow plants just to help the soil.', HIGH_SCHOOL: 'Explore cover crop species, benefits, and management strategies.', UNDERGRADUATE: 'Analyze cover crop selection, termination methods, and system integration.', GRADUATE: 'Examine cover crop impacts on soil health, nutrient cycling, and economics.', PHD: 'Research cover crop breeding, microbiome interactions, and ecosystem services.' },
  ...
  lessons: [{ id: 'cover-1', title: 'Soil Blankets', content: { ELEMENTARY: '<h2>Plant Blankets!</h2><p>Cover crops are plants that cover the soil to protect it from sun, wind, and rain!</p>', MIDDLE_SCHOOL: '<h2>Cover Crop Benefits</h2><p>Prevent erosion, add organic matter, fix nitrogen, suppress weeds, provide habitat.</p>', HIGH_SCHOOL: '<h2>Cover Crop Types</h2><p>Grasses (rye, oats), legumes (clover, vetch), brassicas (radish, turnip). Choose based on goals.</p>', UNDERGRADUATE: '<h2>Management</h2><p>Planting timing, seeding rates, species mixes, termination (tillage, crimping, herbicide, winterkill).</p>', GRADUATE: '<h2>Systems Integration</h2><p>Cash crop effects, nutrient credits, water dynamics, pest/disease considerations.</p>', PHD: '<h2>Research Frontiers</h2><p>Breeding for dual-purpose, root exudate chemistry, ecosystem service quantification.</p>' } }],
  ...
  game: { id: 'cover-game', title: 'Cover Crop Farmer', type: 'simulation', description: 'Manage cover crops through the year', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const noTillFarming: Module = {
  ...
  description: { ELEMENTARY: 'Learn why not digging up soil can be good for farms!', MIDDLE_SCHOOL: 'Discover how farmers grow crops without plowing.', HIGH_SCHOOL: 'Explore no-till systems, equipment, and soil health benefits.', UNDERGRADUATE: 'Analyze no-till transition, weed management, and soil biology.', GRADUATE: 'Examine no-till economics, regional adaptation, and carbon implications.', PHD: 'Research tillage effects on soil microbiome, carbon dynamics, and scaling.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'notill-1', title: 'Don\'t Dig It!', content: { ELEMENTARY: '<h2>Leave the Soil Alone!</h2><p>Plowing breaks up the underground homes of helpful creatures. No-till farming leaves them in peace!</p>', MIDDLE_SCHOOL: '<h2>Why No-Till?</h2><p>Protects soil structure, saves fuel, reduces erosion, keeps carbon in ground, supports soil life.</p>', HIGH_SCHOOL: '<h2>No-Till Systems</h2><p>Direct seeding into residue. Requires specialized planters, cover crops, different weed strategies.</p>', UNDERGRADUATE: '<h2>Transition Challenges</h2><p>3-5 year soil adjustment, initial yield dip, equipment investment, weed management learning curve.</p>', GRADUATE: '<h2>Regional Considerations</h2><p>Climate adaptation, soil type effects, organic vs conventional no-till, integration with other practices.</p>', PHD: '<h2>Research Questions</h2><p>Stratification of nutrients, compaction management, N immobilization, long-term carbon sequestration.</p>' } }],
  ...
  game: { id: 'notill-game', title: 'No-Till Challenge', type: 'simulation', description: 'Farm without tilling', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const composting: Module = {
  ...
  description: { ELEMENTARY: 'Learn how dead plants turn into super soil food!', MIDDLE_SCHOOL: 'Discover the science of decomposition and making compost.', HIGH_SCHOOL: 'Explore composting methods, C:N ratios, and farm-scale systems.', UNDERGRADUATE: 'Analyze compost chemistry, biology, and application strategies.', GRADUATE: 'Examine commercial composting, regulations, and compost tea.', PHD: 'Research compost microbiome, disease suppression, and soil amendment optimization.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'compost-1', title: 'Black Gold', content: { ELEMENTARY: '<h2>Magic Transformation!</h2><p>Leaves, food scraps, and manure become dark, crumbly compost that plants love!</p>', MIDDLE_SCHOOL: '<h2>How Composting Works</h2><p>Microbes break down organic matter. Need carbon (browns), nitrogen (greens), water, and air.</p>', HIGH_SCHOOL: '<h2>Composting Science</h2><p>C:N ratio of 25-30:1 ideal. Thermophilic (hot) phase kills pathogens. Curing stabilizes nutrients.</p>', UNDERGRADUATE: '<h2>Compost Systems</h2><p>Windrows, static piles, in-vessel, vermicompost. Temperature monitoring, turning schedules, maturity testing.</p>', GRADUATE: '<h2>Commercial Operations</h2><p>Feedstock sourcing, regulatory compliance, odor control, product markets, quality standards.</p>', PHD: '<h2>Research Areas</h2><p>Pathogen reduction modeling, ARG fate, biochar-compost synergies, disease suppressive compost.</p>' } }],
  ...
  game: { id: 'compost-game', title: 'Compost Chef', type: 'puzzle', description: 'Mix the perfect compost recipe', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const cropRotation: Module = {
  ...
  description: { ELEMENTARY: 'Learn why farmers plant different crops in different years!', MIDDLE_SCHOOL: 'Discover how changing crops keeps soil and plants healthy.', HIGH_SCHOOL: 'Explore rotation design, pest cycles, and nutrient management.', UNDERGRADUATE: 'Analyze rotation economics, duration effects, and system optimization.', GRADUATE: 'Examine complex rotations, cover crop integration, and modeling.', PHD: 'Research rotation effects on microbiome, disease dynamics, and long-term productivity.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'rotation-1', title: 'Taking Turns', content: { ELEMENTARY: '<h2>Plants Take Turns!</h2><p>Growing different crops each year keeps soil happy and pests confused!</p>', MIDDLE_SCHOOL: '<h2>Why Rotate Crops?</h2><p>Break pest/disease cycles, balance nutrients (legumes add N), improve soil structure, manage weeds.</p>', HIGH_SCHOOL: '<h2>Rotation Design</h2><p>Alternate families, deep vs shallow roots, high vs low residue, cash crops with cover crops.</p>', UNDERGRADUATE: '<h2>Complex Rotations</h2><p>5-7 year rotations, enterprise integration, economic optimization, flexibility principles.</p>', GRADUATE: '<h2>System Effects</h2><p>Long-term trial data, rotation legacy effects, soil health trajectories, modeling approaches.</p>', PHD: '<h2>Research Frontiers</h2><p>Microbiome succession, allelopathy, cover crop placement, climate adaptation.</p>' } }],
...
export const agroforestry: Module = {
  ...
  description: { ELEMENTARY: 'Learn how trees and crops can grow together like friends!', MIDDLE_SCHOOL: 'Discover farming systems that combine trees with crops or animals.', HIGH_SCHOOL: 'Explore agroforestry types: alley cropping, silvopasture, forest farming.', UNDERGRADUATE: 'Analyze agroforestry design, species selection, and economics.', GRADUATE: 'Examine carbon sequestration, ecosystem services, and policy frameworks.', PHD: 'Research tree-crop interactions, below-ground dynamics, and landscape integration.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 35, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'agrofor-1', title: 'Trees + Farms', content: { ELEMENTARY: '<h2>Forest Farms!</h2><p>Trees give shade, food, and homes for birds while crops grow below!</p>', MIDDLE_SCHOOL: '<h2>Agroforestry Types</h2><p>Alley cropping (tree rows with crops), silvopasture (trees + grazing), forest farming (crops under trees).</p>', HIGH_SCHOOL: '<h2>Benefits</h2><p>Diversified income, carbon storage, wildlife habitat, windbreaks, microclimate moderation.</p>', UNDERGRADUATE: '<h2>Design Principles</h2><p>Species compatibility, spacing, light competition, root interactions, succession planning.</p>', GRADUATE: '<h2>Carbon Accounting</h2><p>Above and belowground biomass, soil carbon, avoided emissions, permanence considerations.</p>', PHD: '<h2>Research Areas</h2><p>Hydraulic redistribution, nutrient pumping, biodiversity metrics, landscape connectivity.</p>' } }],
  ...
  game: { id: 'agrofor-game', title: 'Forest Farmer', type: 'simulation', description: 'Manage trees and crops together', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const silvopasture: Module = {
  ...
  description: { ELEMENTARY: 'Learn how cows and trees can share the same land!', MIDDLE_SCHOOL: 'Discover grazing systems with trees for shade and food.', HIGH_SCHOOL: 'Explore silvopasture design, tree species, and animal welfare benefits.', UNDERGRADUATE: 'Analyze silvopasture economics, forage production, and establishment.', GRADUATE: 'Examine carbon sequestration potential and climate resilience.', PHD: 'Research tree-animal interactions, microclimate effects, and productivity optimization.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'silvo-1', title: 'Shady Pastures', content: { ELEMENTARY: '<h2>Happy Animals!</h2><p>Cows love shade from trees on hot days, and trees get fertilizer from the cows!</p>', MIDDLE_SCHOOL: '<h2>Silvopasture Benefits</h2><p>Animal welfare, drought resilience, timber/fruit income, carbon storage, habitat.</p>', HIGH_SCHOOL: '<h2>System Design</h2><p>Tree spacing, species selection, grazing management, tree protection from animals.</p>', UNDERGRADUATE: '<h2>Establishment</h2><p>Existing woodlands vs new plantings, costs, timeline to productivity, grazing deferrals.</p>', GRADUATE: '<h2>Climate Benefits</h2><p>High carbon sequestration (1-10 Mg C/ha/yr), methane considerations, adaptation co-benefits.</p>', PHD: '<h2>Research Frontiers</h2><p>Thermal comfort quantification, below-ground carbon, optimal tree density, multi-species grazing.</p>' } }],
  ...
  game: { id: 'silvo-game', title: 'Silvopasture Manager', type: 'simulation', description: 'Balance trees, grass, and animals', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const holisticGrazing: Module = {
  ...
  description: { ELEMENTARY: 'Learn how moving animals around helps grass grow better!', MIDDLE_SCHOOL: 'Discover planned grazing that mimics wild herds.', HIGH_SCHOOL: 'Explore adaptive multi-paddock grazing, recovery periods, and land restoration.', UNDERGRADUATE: 'Analyze grazing planning, monitoring, and ecosystem recovery.', GRADUATE: 'Examine holistic management framework, land regeneration claims and evidence.', PHD: 'Research grazing impacts on soil carbon, biodiversity, and landscape function.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 35, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'graze-1', title: 'Moving Herds', content: { ELEMENTARY: '<h2>Follow the Herd!</h2><p>Moving animals often gives grass time to rest and regrow tall and strong!</p>', MIDDLE_SCHOOL: '<h2>Rotational Grazing</h2><p>Move animals frequently, give pastures recovery time, mimic natural herd movement.</p>', HIGH_SCHOOL: '<h2>Adaptive Management</h2><p>Stock density, recovery periods (30-90 days), monitoring plant response, adjusting plan.</p>', UNDERGRADUATE: '<h2>Planning Tools</h2><p>Grazing charts, stocking rate calculations, carrying capacity, drought reserves.</p>', GRADUATE: '<h2>Evidence Base</h2><p>Mixed research results, context dependency, management intensity effects, carbon claims.</p>', PHD: '<h2>Research Questions</h2><p>Optimal rest periods, trampling effects, biodiversity responses, soil health indicators.</p>' } }],
  ...
  game: { id: 'graze-game', title: 'Herd Manager', type: 'simulation', description: 'Move animals for healthy pastures', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const permacultureDesign: Module = {
  ...
  description: { ELEMENTARY: 'Learn to design gardens that work like nature!', MIDDLE_SCHOOL: 'Discover design principles for sustainable food systems.', HIGH_SCHOOL: 'Explore permaculture ethics, principles, and design methodology.', UNDERGRADUATE: 'Analyze whole-system design, zones, sectors, and pattern application.', GRADUATE: 'Examine permaculture in professional design, critiques, and evidence.', PHD: 'Research permaculture systems performance, scaling challenges, and integration.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 35, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'perma-1', title: 'Design Like Nature', content: { ELEMENTARY: '<h2>Copy Nature!</h2><p>Permaculture designs gardens that work like forests - many plants helping each other!</p>', MIDDLE_SCHOOL: '<h2>Permaculture Ethics</h2><p>Earth care, people care, fair share. Design with nature, not against it.</p>', HIGH_SCHOOL: '<h2>Design Principles</h2><p>Observe and interact, catch and store energy, obtain a yield, apply self-regulation, value diversity.</p>', UNDERGRADUATE: '<h2>Zone Planning</h2><p>Zone 0 (home) to Zone 5 (wild). Place elements by frequency of use and care needs.</p>', GRADUATE: '<h2>Professional Application</h2><p>Site analysis, client goals, design documentation, implementation phasing.</p>', PHD: '<h2>Research Areas</h2><p>Productivity comparisons, labor requirements, scaling limitations, hybrid approaches.</p>' } }],
  ...
  game: { id: 'perma-game', title: 'Permaculture Designer', type: 'puzzle', description: 'Create integrated designs', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const polycultures: Module = {
  ...
  description: { ELEMENTARY: 'Learn how growing many plants together helps them all!', MIDDLE_SCHOOL: 'Discover the benefits of growing multiple crops together.', HIGH_SCHOOL: 'Explore intercropping, companion planting, and guild design.', UNDERGRADUATE: 'Analyze polyculture productivity, competition, and facilitation.', GRADUATE: 'Examine commercial polycultures, mechanization, and market integration.', PHD: 'Research polyculture optimization, ecological mechanisms, and breeding implications.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'poly-1', title: 'Plants as Friends', content: { ELEMENTARY: '<h2>Plant Communities!</h2><p>Some plants help each other grow - like corn, beans, and squash (the Three Sisters)!</p>', MIDDLE_SCHOOL: '<h2>Companion Planting</h2><p>Plants can share nutrients, repel pests, attract pollinators, and provide support for each other.</p>', HIGH_SCHOOL: '<h2>Intercropping Types</h2><p>Strip intercropping, relay cropping, mixed intercropping. Land Equivalent Ratio (LER) measures efficiency.</p>', UNDERGRADUATE: '<h2>Ecological Mechanisms</h2><p>Complementary resource use, facilitation, reduced pest pressure, enhanced pollination.</p>', GRADUATE: '<h2>Commercial Systems</h2><p>Mechanical harvesting challenges, market complexity, risk reduction, insurance considerations.</p>', PHD: '<h2>Research Areas</h2><p>Functional trait matching, below-ground interactions, breeding for polycultures, modeling.</p>' } }],
  ...
  game: { id: 'poly-game', title: 'Polyculture Planner', type: 'puzzle', description: 'Match plants that help each other', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const integratedPestManagement: Module = {
  ...
  description: { ELEMENTARY: 'Learn how to manage pests without hurting nature!', MIDDLE_SCHOOL: 'Discover smart ways to control pests using nature\'s helpers.', HIGH_SCHOOL: 'Explore IPM strategies: prevention, monitoring, and intervention thresholds.', UNDERGRADUATE: 'Analyze biological control, cultural practices, and economic thresholds.', GRADUATE: 'Examine landscape-level IPM, resistance management, and organic systems.', PHD: 'Research ecological pest management, push-pull strategies, and gene drive implications.' },
  topic: 'regenerative-agriculture',
  estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'ipm-1', title: 'Smart Pest Control', content: { ELEMENTARY: '<h2>Nature\'s Pest Patrol!</h2><p>Ladybugs eat aphids, birds eat caterpillars - nature has its own pest control!</p>', MIDDLE_SCHOOL: '<h2>IPM Pyramid</h2><p>Prevention first, then monitoring, biological control, cultural practices, and chemicals as last resort.</p>', HIGH_SCHOOL: '<h2>IPM Components</h2><p>Pest identification, scouting, economic thresholds, beneficial insects, resistant varieties, targeted treatments.</p>', UNDERGRADUATE: '<h2>Biological Control</h2><p>Conservation, augmentation, and classical biological control. Natural enemies, parasitoids, pathogens.</p>', GRADUATE: '<h2>Systems Approach</h2><p>Habitat management, field borders, landscape composition, resistance evolution prevention.</p>', PHD: '<h2>Research Frontiers</h2><p>RNAi pesticides, microbiome manipulation, precision application, climate change effects.</p>' } }],
  ...
  game: { id: 'ipm-game', title: 'Pest Manager', type: 'simulation', description: 'Balance pest control naturally', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const beneficialInsects: Module = {
  ...
  description: { ELEMENTARY: 'Learn about helpful bugs that protect gardens!', MIDDLE_SCHOOL: 'Discover insects that help farmers by eating pests and pollinating.', HIGH_SCHOOL: 'Explore beneficial insect ecology, habitat, and conservation.', UNDERGRADUATE: 'Analyze insectary establishment, augmentation strategies, and monitoring.', GRADUATE: 'Examine landscape ecology of beneficials and on-farm management.', PHD: 'Research pollinator-pest interactions, ecosystem services, and conservation biological control.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'bugs-1', title: 'Good Bugs', content: { ELEMENTARY: '<h2>Bug Heroes!</h2><p>Ladybugs, lacewings, and bees are garden superheroes that help plants!</p>', MIDDLE_SCHOOL: '<h2>Beneficial Types</h2><p>Predators (ladybugs, spiders), parasitoids (wasps), pollinators (bees, butterflies), decomposers.</p>', HIGH_SCHOOL: '<h2>Habitat Needs</h2><p>Flower strips, hedgerows, overwintering sites, water, diverse plantings for year-round resources.</p>', UNDERGRADUATE: '<h2>Conservation</h2><p>Reducing pesticides, providing habitat, augmentation releases, banker plants.</p>', GRADUATE: '<h2>Landscape Effects</h2><p>Field margins, landscape complexity, source populations, spillover dynamics.</p>', PHD: '<h2>Research</h2><p>Ecosystem service quantification, trait-based approaches, climate effects on phenology.</p>' } }],
  ...
  game: { id: 'bugs-game', title: 'Bug Sanctuary', type: 'simulation', description: 'Create habitat for beneficial insects', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const organicFertilizers: Module = {
  ...
  description: { ELEMENTARY: 'Learn how plants get food from nature!', MIDDLE_SCHOOL: 'Discover natural ways to feed plants and soil.', HIGH_SCHOOL: 'Explore organic nutrient sources, application, and soil biology.', UNDERGRADUATE: 'Analyze nutrient release dynamics, timing, and system integration.', GRADUATE: 'Examine organic fertility management, nutrient budgets, and regulations.', PHD: 'Research mineralization kinetics, soil biology interactions, and circular systems.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'orgfert-1', title: 'Natural Plant Food', content: { ELEMENTARY: '<h2>Nature\'s Vitamins!</h2><p>Compost, manure, and bone meal give plants the nutrients they need to grow strong!</p>', MIDDLE_SCHOOL: '<h2>Organic Sources</h2><p>Compost, manures, green manures, bone meal, blood meal, kelp, rock phosphate.</p>', HIGH_SCHOOL: '<h2>Nutrient Release</h2><p>Slow release as microbes break down organic matter. Timing, temperature, and moisture matter.</p>', UNDERGRADUATE: '<h2>Fertility Planning</h2><p>Soil testing, nutrient budgets, source selection, application rates and timing.</p>', GRADUATE: '<h2>System Integration</h2><p>Cover crop nitrogen, manure management, nutrient cycling, regulatory compliance.</p>', PHD: '<h2>Research Areas</h2><p>C:N ratio effects, priming, micronutrient availability, circular economy approaches.</p>' } }],
  ...
  game: { id: 'orgfert-game', title: 'Nutrient Manager', type: 'puzzle', description: 'Feed plants naturally', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const biochar: Module = {
  ...
  description: { ELEMENTARY: 'Learn how charcoal can help soil!', MIDDLE_SCHOOL: 'Discover biochar - ancient soil magic for modern farms.', HIGH_SCHOOL: 'Explore biochar production, properties, and soil applications.', UNDERGRADUATE: 'Analyze biochar effects on soil properties, nutrients, and carbon storage.', GRADUATE: 'Examine biochar economics, lifecycle assessment, and carbon markets.', PHD: 'Research biochar-microbiome interactions, aging, and mechanism elucidation.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'biochar-1', title: 'Super Charcoal', content: { ELEMENTARY: '<h2>Magic Black Stuff!</h2><p>Biochar is like charcoal that helps soil hold water and nutrients!</p>', MIDDLE_SCHOOL: '<h2>What is Biochar?</h2><p>Charcoal made for soil. Holds water, nutrients, and microbe homes. Lasts hundreds of years.</p>', HIGH_SCHOOL: '<h2>Production</h2><p>Pyrolysis (heating without oxygen). Feedstock affects properties. Terra preta inspiration.</p>', UNDERGRADUATE: '<h2>Soil Effects</h2><p>CEC increase, water retention, pH buffering, microbial habitat, nutrient retention.</p>', GRADUATE: '<h2>Carbon Storage</h2><p>Stable carbon form, MRV challenges, lifecycle emissions, co-product value.</p>', PHD: '<h2>Research Frontiers</h2><p>Designer biochar, functionalization, aging effects, context-specific responses.</p>' } }],
...
export const keylineDesign: Module = {
  ...
  description: { ELEMENTARY: 'Learn how farmers follow hills to save water!', MIDDLE_SCHOOL: 'Discover how landforms guide water management.', HIGH_SCHOOL: 'Explore keyline principles for water distribution and soil building.', UNDERGRADUATE: 'Analyze keyline surveying, plow patterns, and landscape hydrology.', GRADUATE: 'Examine keyline integration with other practices and economic analysis.', PHD: 'Research landscape-scale water management and soil development.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'key-1', title: 'Following the Land', content: { ELEMENTARY: '<h2>Water Paths!</h2><p>Keyline design helps water spread across fields instead of running away!</p>', MIDDLE_SCHOOL: '<h2>Keyline Basics</h2><p>Find key points on ridges, plow parallel lines to spread water from valleys to ridges.</p>', HIGH_SCHOOL: '<h2>Keyline System</h2><p>Key point, keyline, parallel cultivation, tree lines, dams. Water harvesting and distribution.</p>', UNDERGRADUATE: '<h2>Implementation</h2><p>Surveying methods, plow design, cultivation patterns, integration with grazing.</p>', GRADUATE: '<h2>Landscape Effects</h2><p>Soil building rates, water infiltration, drought resilience, carbon sequestration.</p>', PHD: '<h2>Research Areas</h2><p>Hydrological modeling, soil formation rates, scaling principles, economic returns.</p>' } }],
  ...
  game: { id: 'key-game', title: 'Keyline Planner', type: 'puzzle', description: 'Design keyline water systems', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const seedSaving: Module = {
  ...
  description: { ELEMENTARY: 'Learn how to save seeds from your plants!', MIDDLE_SCHOOL: 'Discover the art of collecting and storing seeds.', HIGH_SCHOOL: 'Explore seed biology, isolation, and selection techniques.', UNDERGRADUATE: 'Analyze genetic diversity, population genetics, and seed system design.', GRADUATE: 'Examine participatory plant breeding and seed sovereignty.', PHD: 'Research genetic erosion, in-situ conservation, and farmer-led innovation.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'seed-1', title: 'Saving Seeds', content: { ELEMENTARY: '<h2>Seeds for Next Year!</h2><p>Plants make seeds that grow into new plants - save them to grow more!</p>', MIDDLE_SCHOOL: '<h2>Seed Basics</h2><p>Let fruits ripen, collect seeds, dry them, store cool and dry. Open-pollinated vs hybrid.</p>', HIGH_SCHOOL: '<h2>Selection & Isolation</h2><p>Choose best plants, maintain isolation distances to prevent crossing, population size for diversity.</p>', UNDERGRADUATE: '<h2>Genetic Considerations</h2><p>Inbreeding depression, outcrossing, selection pressure, founder effects, population size.</p>', GRADUATE: '<h2>Seed Systems</h2><p>Formal vs informal, seed sovereignty, community seed banks, participatory breeding.</p>', PHD: '<h2>Research Areas</h2><p>Genetic diversity assessment, adaptation to local conditions, climate resilience breeding.</p>' } }],
  ...
  game: { id: 'seed-game', title: 'Seed Keeper', type: 'simulation', description: 'Build a seed collection', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const heritageBreeds: Module = {
  ...
  description: { ELEMENTARY: 'Learn about special old animal breeds!', MIDDLE_SCHOOL: 'Discover heritage livestock and why they matter.', HIGH_SCHOOL: 'Explore breed conservation, traits, and agricultural importance.', UNDERGRADUATE: 'Analyze genetic diversity, conservation breeding, and market development.', GRADUATE: 'Examine breed conservation policy, genetic resource management.', PHD: 'Research conservation genetics, adaptation traits, and climate resilience.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'heritage-1', title: 'Old Breeds', content: { ELEMENTARY: '<h2>Special Animals!</h2><p>Heritage breeds are old types of farm animals that our grandparents raised!</p>', MIDDLE_SCHOOL: '<h2>Why Heritage?</h2><p>Unique traits, hardiness, flavor, genetic diversity, cultural heritage. Many are endangered.</p>', HIGH_SCHOOL: '<h2>Conservation</h2><p>Breed characteristics, registry systems, conservation priority, niche markets, pasture-based systems.</p>', UNDERGRADUATE: '<h2>Genetics</h2><p>Effective population size, inbreeding, outcrossing, trait selection, breed standards.</p>', GRADUATE: '<h2>Policy & Markets</h2><p>Conservation funding, slow food movement, direct marketing, farm-to-table.</p>', PHD: '<h2>Research</h2><p>Genomic characterization, adaptive traits, functional diversity, climate resilience potential.</p>' } }],
  ...
  game: { id: 'heritage-game', title: 'Heritage Farmer', type: 'simulation', description: 'Raise heritage animals', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const carbonFarming: Module = {
  ...
  description: { ELEMENTARY: 'Learn how farms can capture carbon like trees!', MIDDLE_SCHOOL: 'Discover how farming practices store carbon in soil.', HIGH_SCHOOL: 'Explore carbon sequestration practices, measurement, and markets.', UNDERGRADUATE: 'Analyze carbon farming protocols, MRV, and economic incentives.', GRADUATE: 'Examine carbon credit markets, additionality, and permanence.', PHD: 'Research soil carbon dynamics, verification methods, and policy design.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 35, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'carbon-1', title: 'Storing Carbon', content: { ELEMENTARY: '<h2>Carbon Catchers!</h2><p>Plants grab carbon from the air and put it in the soil where it helps things grow!</p>', MIDDLE_SCHOOL: '<h2>How It Works</h2><p>Photosynthesis captures CO2, roots deposit carbon in soil. Practices: cover crops, no-till, trees.</p>', HIGH_SCHOOL: '<h2>Carbon Markets</h2><p>Farmers can sell carbon credits. Requires measurement, verification, permanence.</p>', UNDERGRADUATE: '<h2>Protocols</h2><p>Verra, Gold Standard, ACR. Baseline, additionality, leakage, permanence requirements.</p>', GRADUATE: '<h2>Market Issues</h2><p>Crediting periods, reversal buffers, stacking, methodology evolution, buyer requirements.</p>', PHD: '<h2>Research Questions</h2><p>Detection of change, uncertainty quantification, remote sensing verification, modeling approaches.</p>' } }],
...
export const soilTesting: Module = {
  ...
  description: { ELEMENTARY: 'Learn how scientists check if soil is healthy!', MIDDLE_SCHOOL: 'Discover how to test soil for nutrients and health.', HIGH_SCHOOL: 'Explore soil test interpretation and management decisions.', UNDERGRADUATE: 'Analyze soil testing methods, labs, and recommendations.', GRADUATE: 'Examine advanced soil health indicators and precision agriculture.', PHD: 'Research novel soil health metrics and rapid assessment tools.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'test-1', title: 'Testing Soil', content: { ELEMENTARY: '<h2>Soil Check-Up!</h2><p>Just like going to the doctor, soil needs check-ups to see if it\'s healthy!</p>', MIDDLE_SCHOOL: '<h2>What Tests Show</h2><p>pH, nutrients (N, P, K), organic matter, texture. Helps decide what soil needs.</p>', HIGH_SCHOOL: '<h2>Testing Types</h2><p>Standard fertility, soil health (HANEY, Solvita), biological assessments, micronutrients.</p>', UNDERGRADUATE: '<h2>Interpretation</h2><p>Understanding results, regional calibrations, economic thresholds, recommendation systems.</p>', GRADUATE: '<h2>Advanced Metrics</h2><p>Soil protein, respiration, aggregate stability, infiltration, biologicalindicators.</p>', PHD: '<h2>Research</h2><p>Spectroscopic methods, in-field sensors, eDNA, health index development.</p>' } }],
  ...
  game: { id: 'test-game', title: 'Soil Detective', type: 'puzzle', description: 'Diagnose soil problems', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const nitrogenFixation: Module = {
  ...
  description: { ELEMENTARY: 'Learn how special plants make their own fertilizer!', MIDDLE_SCHOOL: 'Discover how legumes and bacteria create nitrogen.', HIGH_SCHOOL: 'Explore biological nitrogen fixation and legume management.', UNDERGRADUATE: 'Analyze N fixation rates, inoculants, and system integration.', GRADUATE: 'Examine N credits, measurement methods, and cropping systems.', PHD: 'Research symbiotic efficiency, free-living fixers, and genetic improvement.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'nfix-1', title: 'Free Fertilizer', content: { ELEMENTARY: '<h2>Plant Partnerships!</h2><p>Peas, beans, and clovers team up with tiny bacteria to make their own fertilizer!</p>', MIDDLE_SCHOOL: '<h2>How It Works</h2><p>Rhizobia bacteria live in root nodules. They turn air nitrogen into plant food. Legumes give bacteria sugars.</p>', HIGH_SCHOOL: '<h2>Managing Legumes</h2><p>Inoculation, variety selection, rotational placement, estimating N contribution to following crops.</p>', UNDERGRADUATE: '<h2>Fixation Rates</h2><p>50-300 kg N/ha depending on species, conditions. Measuring with isotopes or difference methods.</p>', GRADUATE: '<h2>Systems Integration</h2><p>Cover crop N, pasture renovation, intercrops, timing of incorporation, N credits.</p>', PHD: '<h2>Research Areas</h2><p>Engineering fixation in non-legumes, improving efficiency, free-living fixers, climate effects.</p>' } }],
  ...
  game: { id: 'nfix-game', title: 'Nitrogen Farmer', type: 'simulation', description: 'Grow nitrogen for your farm', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const mulching: Module = {
  ...
  description: { ELEMENTARY: 'Learn how to tuck soil in with a blanket!', MIDDLE_SCHOOL: 'Discover how mulch protects soil and saves water.', HIGH_SCHOOL: 'Explore mulch types, application, and effects on soil.', UNDERGRADUATE: 'Analyze mulching in different systems and economic returns.', GRADUATE: 'Examine mulch decomposition, nutrient dynamics, and weed suppression.', PHD: 'Research mulch effects on soil biology, microclimate, and carbon.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 25, HIGH_SCHOOL: 40, UNDERGRADUATE: 55, GRADUATE: 75, PHD: 100 },
  lessons: [{ id: 'mulch-1', title: 'Soil Blankets', content: { ELEMENTARY: '<h2>Cozy Soil!</h2><p>Mulch is like a blanket for soil - it keeps it cool in summer and warm in winter!</p>', MIDDLE_SCHOOL: '<h2>Mulch Benefits</h2><p>Keeps moisture in, stops weeds, adds organic matter, protects from erosion, moderates temperature.</p>', HIGH_SCHOOL: '<h2>Mulch Types</h2><p>Organic (straw, wood chips, leaves), living (cover crops), synthetic. Depth and timing matter.</p>', UNDERGRADUATE: '<h2>System Integration</h2><p>No-till, perennials, tree crops, vegetable production, economic analysis.</p>', GRADUATE: '<h2>Decomposition</h2><p>C:N effects, nutrient immobilization, allelopathy, soil biology changes.</p>', PHD: '<h2>Research</h2><p>Microclimate modification, soil fauna, long-term soil carbon, regional appropriateness.</p>' } }],
  ...
  game: { id: 'mulch-game', title: 'Mulch Master', type: 'puzzle', description: 'Choose the right mulch', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const hedgerowsWindbreaks: Module = {
  ...
  description: { ELEMENTARY: 'Learn how rows of trees protect farms!', MIDDLE_SCHOOL: 'Discover how hedgerows and windbreaks help farms and wildlife.', HIGH_SCHOOL: 'Explore windbreak design, species selection, and ecosystem benefits.', UNDERGRADUATE: 'Analyze windbreak effects on microclimate, yield, and biodiversity.', GRADUATE: 'Examine landscape-level hedgerow networks and ecosystem services.', PHD: 'Research connectivity, habitat corridors, and climate adaptation.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'hedge-1', title: 'Living Fences', content: { ELEMENTARY: '<h2>Tree Walls!</h2><p>Rows of trees and bushes protect crops from wind and give homes to birds!</p>', MIDDLE_SCHOOL: '<h2>Windbreak Benefits</h2><p>Reduce wind speed, prevent erosion, wildlife habitat, snow management, microclimate.</p>', HIGH_SCHOOL: '<h2>Design Principles</h2><p>Height, density, orientation, species mix, porosity. Protection extends 10-20x height downwind.</p>', UNDERGRADUATE: '<h2>Ecosystem Services</h2><p>Carbon storage, pest control, pollinator habitat, water quality, aesthetic value.</p>', GRADUATE: '<h2>Landscape Planning</h2><p>Network connectivity, habitat corridors, landscape ecology, policy incentives.</p>', PHD: '<h2>Research</h2><p>Microclimate modeling, biodiversity assessment, carbon accounting, economic valuation.</p>' } }],
  ...
  game: { id: 'hedge-game', title: 'Windbreak Designer', type: 'puzzle', description: 'Create effective windbreaks', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const farmBiodiversity: Module = {
  ...
  description: { ELEMENTARY: 'Learn why farms need many different plants and animals!', MIDDLE_SCHOOL: 'Discover how biodiversity makes farms healthier and more productive.', HIGH_SCHOOL: 'Explore on-farm biodiversity management and ecosystem services.', UNDERGRADUATE: 'Analyze agrobiodiversity assessment, conservation, and functional diversity.', GRADUATE: 'Examine biodiversity-ecosystem function relationships in agriculture.', PHD: 'Research biodiversity metrics, landscape genetics, and conservation strategies.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'bio-1', title: 'Variety is Life', content: { ELEMENTARY: '<h2>Nature\'s Team!</h2><p>Farms with many different plants and animals are healthier and grow better food!</p>', MIDDLE_SCHOOL: '<h2>Why Biodiversity?</h2><p>Pest control, pollination, resilience, soil health, beauty. Monocultures are vulnerable.</p>', HIGH_SCHOOL: '<h2>Types of Diversity</h2><p>Genetic, species, ecosystem. Planned vs associated biodiversity. Wild vs cultivated.</p>', UNDERGRADUATE: '<h2>Functional Diversity</h2><p>Traits that provide services: pollinators, predators, decomposers, nitrogen fixers.</p>', GRADUATE: '<h2>Assessment</h2><p>Biodiversity indices, monitoring protocols, indicators, response to management.</p>', PHD: '<h2>Research Frontiers</h2><p>eDNA, landscape genetics, trait-based ecology, BEF relationships.</p>' } }],
  ...
  game: { id: 'bio-game', title: 'Diversity Builder', type: 'simulation', description: 'Increase farm biodiversity', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const localFoodSystems: Module = {
  ...
  description: { ELEMENTARY: 'Learn why eating local food helps farmers and the planet!', MIDDLE_SCHOOL: 'Discover how local food connects farmers and communities.', HIGH_SCHOOL: 'Explore local food economics, marketing, and sustainability.', UNDERGRADUATE: 'Analyze food system localization, supply chains, and food security.', GRADUATE: 'Examine food sovereignty, alternative food networks, and policy.', PHD: 'Research food system transformation, metrics, and just transitions.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'local-1', title: 'Food from Nearby', content: { ELEMENTARY: '<h2>Know Your Farmer!</h2><p>Food from nearby farms is fresher and helps farmers in your community!</p>', MIDDLE_SCHOOL: '<h2>Local Food Benefits</h2><p>Fresher food, less transport pollution, supports local economy, seasonal eating, connection.</p>', HIGH_SCHOOL: '<h2>Direct Marketing</h2><p>Farmers markets, CSA, farm stands, restaurants, institutions. Building relationships.</p>', UNDERGRADUATE: '<h2>Food Systems Analysis</h2><p>Supply chains, food miles, embedded energy, regional food assessments, food hubs.</p>', GRADUATE: '<h2>Policy & Planning</h2><p>Food policy councils, procurement policy, land use, food access, infrastructure.</p>', PHD: '<h2>Research</h2><p>Food system resilience, equity analysis, scaling strategies, transformation pathways.</p>' } }],
  ...
  game: { id: 'local-game', title: 'Local Food Builder', type: 'simulation', description: 'Build local food connections', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const regenerativeRanching: Module = {
  ...
  description: { ELEMENTARY: 'Learn how cattle can help grasslands!', MIDDLE_SCHOOL: 'Discover how well-managed grazing improves land.', HIGH_SCHOOL: 'Explore regenerative grazing systems and rangeland ecology.', UNDERGRADUATE: 'Analyze stocking rates, grazing management, and ecosystem recovery.', GRADUATE: 'Examine landscape-scale ranching, economics, and climate implications.', PHD: 'Research grazing-carbon-biodiversity interactions and evidence synthesis.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 35, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'ranch-1', title: 'Cattle as Tools', content: { ELEMENTARY: '<h2>Helpful Herds!</h2><p>Cows can help grasslands grow better when moved around properly!</p>', MIDDLE_SCHOOL: '<h2>Regenerative Grazing</h2><p>High density, short duration, long recovery. Mimics wild herds. Builds soil.</p>', HIGH_SCHOOL: '<h2>Rangeland Management</h2><p>Carrying capacity, stocking rate, rest periods, plant succession, water development.</p>', UNDERGRADUATE: '<h2>Systems Approach</h2><p>Adaptive management, monitoring, planning, economics, marketing premiums.</p>', GRADUATE: '<h2>Landscape Scale</h2><p>Large ranch management, ecosystem services, carbon programs, biodiversity.</p>', PHD: '<h2>Research Questions</h2><p>Carbon sequestration rates, methane balance, biodiversity outcomes, scaling evidence.</p>' } }],
  ...
  game: { id: 'ranch-game', title: 'Regenerative Rancher', type: 'simulation', description: 'Build healthy rangelands', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const perennialGrains: Module = {
  ...
  description: { ELEMENTARY: 'Learn about grain plants that grow back every year!', MIDDLE_SCHOOL: 'Discover crops that don\'t need replanting annually.', HIGH_SCHOOL: 'Explore perennial crop development and agricultural benefits.', UNDERGRADUATE: 'Analyze perennial grain breeding, agronomy, and systems.', GRADUATE: 'Examine ecosystem services, adoption barriers, and commercialization.', PHD: 'Research perennial polycultures, breeding approaches, and transformation potential.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'peren-1', title: 'Crops That Stay', content: { ELEMENTARY: '<h2>Plants That Come Back!</h2><p>Imagine grain plants that grow back every year without replanting!</p>', MIDDLE_SCHOOL: '<h2>Why Perennials?</h2><p>No tillage needed, deep roots, erosion control, carbon storage, reduced inputs.</p>', HIGH_SCHOOL: '<h2>Current Crops</h2><p>Kernza (perennial wheat relative), perennial rice, perennial sorghum. Under development.</p>', UNDERGRADUATE: '<h2>Breeding Approaches</h2><p>Domestication of wild perennials, perennialization of annuals, wide hybridization.</p>', GRADUATE: '<h2>System Design</h2><p>Stand longevity, management, markets, policy support, transition strategies.</p>', PHD: '<h2>Research Areas</h2><p>Yield-longevity tradeoffs, resource allocation, polycultures, landscape integration.</p>' } }],
...
export const urbanRegenAg: Module = {
  ...
  description: { ELEMENTARY: 'Learn how to grow food in cities!', MIDDLE_SCHOOL: 'Discover urban farming and city food production.', HIGH_SCHOOL: 'Explore urban agriculture systems, challenges, and benefits.', UNDERGRADUATE: 'Analyze urban farm economics, policy, and community development.', GRADUATE: 'Examine urban food systems, land access, and social equity.', PHD: 'Research urban agroecology, ecosystem services, and food justice.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'urban-1', title: 'City Farms', content: { ELEMENTARY: '<h2>Growing in Cities!</h2><p>You can grow food anywhere - rooftops, vacant lots, backyards, even indoors!</p>', MIDDLE_SCHOOL: '<h2>Urban Ag Types</h2><p>Community gardens, rooftop farms, vertical farms, backyard gardens, school gardens.</p>', HIGH_SCHOOL: '<h2>Challenges & Solutions</h2><p>Space, soil contamination, water access, zoning. Raised beds, soil testing, policy change.</p>', UNDERGRADUATE: '<h2>Economics</h2><p>High-value crops, direct marketing, grants, enterprise models, land tenure.</p>', GRADUATE: '<h2>Social Dimensions</h2><p>Food access, gentrification, community building, workforce development, equity.</p>', PHD: '<h2>Research</h2><p>Urban soil remediation, ecosystem services in cities, food justice frameworks.</p>' } }],
  ...
  game: { id: 'urban-game', title: 'City Farmer', type: 'simulation', description: 'Grow food in the city', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const climateResilientFarming: Module = {
  ...
  description: { ELEMENTARY: 'Learn how farms can handle wild weather!', MIDDLE_SCHOOL: 'Discover farming practices that survive floods, droughts, and storms.', HIGH_SCHOOL: 'Explore climate adaptation strategies for agriculture.', UNDERGRADUATE: 'Analyze climate risk assessment and adaptation planning.', GRADUATE: 'Examine climate-smart agriculture, policy frameworks, and transformation.', PHD: 'Research adaptation pathways, tipping points, and system transformation.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 35, HIGH_SCHOOL: 50, UNDERGRADUATE: 70, GRADUATE: 95, PHD: 125 },
  lessons: [{ id: 'climate-1', title: 'Weather-Ready Farms', content: { ELEMENTARY: '<h2>Strong Farms!</h2><p>Healthy soil and diverse plants help farms survive droughts, floods, and heat!</p>', MIDDLE_SCHOOL: '<h2>Building Resilience</h2><p>Soil organic matter holds water, diversity spreads risk, perennials survive extremes.</p>', HIGH_SCHOOL: '<h2>Adaptation Strategies</h2><p>Drought-tolerant varieties, water harvesting, diversification, insurance, timing shifts.</p>', UNDERGRADUATE: '<h2>Risk Assessment</h2><p>Climate projections, vulnerability analysis, scenario planning, decision support tools.</p>', GRADUATE: '<h2>Climate-Smart Ag</h2><p>Triple wins: productivity, adaptation, mitigation. Policy integration, finance mechanisms.</p>', PHD: '<h2>Research</h2><p>Transformation pathways, maladaptation risks, limits to adaptation, equity dimensions.</p>' } }],
  ...
  game: { id: 'climate-game', title: 'Climate Farmer', type: 'simulation', description: 'Build a resilient farm', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const regenCertification: Module = {
  ...
  description: { ELEMENTARY: 'Learn about special labels for earth-friendly farms!', MIDDLE_SCHOOL: 'Discover how farms prove they help the environment.', HIGH_SCHOOL: 'Explore certification programs, standards, and verification.', UNDERGRADUATE: 'Analyze certification scheme design, market development, and impacts.', GRADUATE: 'Examine certification governance, chain of custody, and effectiveness.', PHD: 'Research certification impacts, standard-setting, and market transformation.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 15, MIDDLE_SCHOOL: 25, HIGH_SCHOOL: 40, UNDERGRADUATE: 55, GRADUATE: 75, PHD: 100 },
  lessons: [{ id: 'cert-1', title: 'Farm Labels', content: { ELEMENTARY: '<h2>Special Stickers!</h2><p>Some foods have labels showing they come from farms that help the Earth!</p>', MIDDLE_SCHOOL: '<h2>What Certification Means</h2><p>Third-party verification of practices. Organic, Regenerative Organic Certified, etc.</p>', HIGH_SCHOOL: '<h2>Certification Programs</h2><p>ROC, Land to Market, A Greener World. Standards, audits, premiums, market access.</p>', UNDERGRADUATE: '<h2>Scheme Design</h2><p>Standard development, assurance systems, chain of custody, claims, premiums.</p>', GRADUATE: '<h2>Effectiveness</h2><p>Impact assessment, additionality, smallholder inclusion, competing standards.</p>', PHD: '<h2>Research</h2><p>Governance, standard harmonization, outcome-based approaches, behavioral effects.</p>' } }],
  ...
  game: { id: 'cert-game', title: 'Certification Manager', type: 'puzzle', description: 'Navigate farm certifications', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const farmingCareers: Module = {
  ...
  description: { ELEMENTARY: 'Learn about jobs on regenerative farms!', MIDDLE_SCHOOL: 'Discover careers in sustainable agriculture.', HIGH_SCHOOL: 'Explore farming career paths and education requirements.', UNDERGRADUATE: 'Analyze agricultural career opportunities and professional development.', GRADUATE: 'Examine farm business development, succession, and leadership.', PHD: 'Research agricultural labor, new farmer support, and workforce development.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 15, MIDDLE_SCHOOL: 25, HIGH_SCHOOL: 40, UNDERGRADUATE: 55, GRADUATE: 75, PHD: 100 },
  lessons: [{ id: 'career-1', title: 'Farm Jobs', content: { ELEMENTARY: '<h2>Farm Work!</h2><p>Farmers grow food, but there are many other jobs too - soil scientists, vets, and more!</p>', MIDDLE_SCHOOL: '<h2>Career Options</h2><p>Farmer, farm manager, agronomist, extension agent, researcher, educator, marketer.</p>', HIGH_SCHOOL: '<h2>Getting Started</h2><p>Apprenticeships, WWOOF, internships, ag degrees, beginning farmer programs.</p>', UNDERGRADUATE: '<h2>Professional Paths</h2><p>Consulting, extension, research, policy, nonprofit, agribusiness, entrepreneurship.</p>', GRADUATE: '<h2>Leadership</h2><p>Farm business planning, succession, mentorship, advocacy, thought leadership.</p>', PHD: '<h2>Research</h2><p>Workforce studies, training effectiveness, new farmer support, labor economics.</p>' } }],
  ...
  game: { id: 'career-game', title: 'Career Builder', type: 'puzzle', description: 'Plan your farm career', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
...
export const waterOnFarms: Module = {
  ...
  description: { ELEMENTARY: 'Learn how farms use and save water!', MIDDLE_SCHOOL: 'Discover smart water management for agriculture.', HIGH_SCHOOL: 'Explore irrigation efficiency, water harvesting, and conservation.', UNDERGRADUATE: 'Analyze farm water budgets, efficiency technologies, and regulations.', GRADUATE: 'Examine water-agriculture nexus, allocation, and sustainability.', PHD: 'Research agricultural water footprints, reuse, and climate adaptation.' },
  topic: 'regenerative-agriculture', estimatedMinutes: { ELEMENTARY: 20, MIDDLE_SCHOOL: 30, HIGH_SCHOOL: 45, UNDERGRADUATE: 65, GRADUATE: 90, PHD: 120 },
  lessons: [{ id: 'farmwater-1', title: 'Farm Water', content: { ELEMENTARY: '<h2>Watering Wisely!</h2><p>Farms need lots of water, but regenerative farms use it carefully and catch rainwater!</p>', MIDDLE_SCHOOL: '<h2>Water Strategies</h2><p>Drip irrigation, rainwater harvesting, swales, ponds, soil health for water holding.</p>', HIGH_SCHOOL: '<h2>Efficiency</h2><p>Irrigation scheduling, soil moisture monitoring, mulching, drought-tolerant crops.</p>', UNDERGRADUATE: '<h2>Water Management</h2><p>Crop water requirements, ET-based scheduling, water budgets, technology adoption.</p>', GRADUATE: '<h2>Policy & Rights</h2><p>Water allocation, agricultural vs urban, groundwater governance, markets.</p>', PHD: '<h2>Research</h2><p>Water productivity, virtual water, managed aquifer recharge, agricultural wastewater.</p>' } }],
  ...
  game: { id: 'farmwater-game', title: 'Water Farmer', type: 'simulation', description: 'Manage farm water wisely', difficulty: { ELEMENTARY: { lives: 5, timeLimit: null, hints: true }, MIDDLE_SCHOOL: { lives: 4, timeLimit: 300, hints: true }, HIGH_SCHOOL: { lives: 3, timeLimit: 240, hints: false }, UNDERGRADUATE: { lives: 3, timeLimit: 180, hints: false }, GRADUATE: { lives: 2, timeLimit: 120, hints: false }, PHD: { lives: 1, timeLimit: 90, hints: false } } },
