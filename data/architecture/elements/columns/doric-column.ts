...
export const DORIC_COLUMN: ArchitecturalElement = {
  ...
  history: {
    ...
    GRADUATE: 'The historiography of Doric origins remains contested, with debates between evolutionary models (from Mycenaean megaron) and revolutionary models (influenced by Egyptian or Near Eastern prototypes). Analysis of specific monuments reveals the order\'s flexibility: the Temple of Apollo at Bassae combines Doric exterior with Ionic and Corinthian interiors. Post-antique reception, from Bramante\'s Tempietto to Schinkel\'s Altes Museum, demonstrates continuous reinterpretation of Doric significance. Comparative architectural analysis reveals non-Western column traditions developed independently: Ethiopian rock-cut churches at Lalibela (12th-13th century) feature bracketed pillars carved from living rock to support barrel vaults and domes, demonstrating distinct architectural vocabularies outside classical orders.',
    PHD: 'Scholarly approaches to the Doric order encompass archaeological reconstruction, proportional analysis, theoretical interpretation, and reception studies. Key debates include: the chronology of order development, the symbolic meanings attributed to Doric in antiquity, the relationship between prescriptive texts (Vitruvius) and built examples, and the ideological deployments of Doric in various historical contexts from Greek civic identity to 18th-century democratic associations. Cross-cultural column studies examine how different traditions developed vertical support vocabularies: Ethiopian bracketed pillars in rock-cut churches (carved from continuous stone connecting floor to ceiling, supporting flat ceilings, barrel vaults, and domes) represent subtractive architecture distinct from additive classical construction, challenging universal narratives of column evolution and revealing culturally-specific architectural development paths.',
  },
