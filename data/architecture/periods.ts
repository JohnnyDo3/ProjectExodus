...
export const ARCHITECTURAL_PERIODS: PeriodDefinition[] = [
  ...
  // ==========================================================================
  {
    ...
    iconicBuildings: [
      { name: 'Eynan (Ain Mallaha)', location: 'Upper Jordan Valley, Israel', year: 'c. 12,500 BCE' },
      { name: 'Wadi Hammeh 27', location: 'Jordan Valley, Jordan', year: 'c. 12,000 BCE' },
      { name: 'El-Wad Terrace', location: 'Mount Carmel, Israel', year: 'c. 11,000 BCE' },
    ],
    influencedBy: [],
    influenced: ['ppna'],
  ...
  },
  {
    ...
    iconicBuildings: [
      { name: 'Gobekli Tepe', location: 'Sanliurfa, Turkey', year: 'c. 9500 BCE' },
      { name: 'Tower of Jericho', location: 'Jericho, Palestine', year: 'c. 8500 BCE' },
      { name: 'Jerf el Ahmar', location: 'Northern Syria', year: 'c. 9000 BCE' },
    ],
  ...
  },
  {
    ...
    iconicBuildings: [
      { name: 'Jericho Walls', location: 'Jericho, Palestine', year: 'c. 8000 BCE' },
      { name: 'Ain Ghazal', location: 'Amman, Jordan', year: 'c. 7500 BCE' },
      { name: 'Cayonu', location: 'Southeastern Turkey', year: 'c. 7500 BCE' },
    ],
    influencedBy: ['ppna'],
  ...
  },
  {
    ...
    iconicBuildings: [
      { name: 'Catalhoyuk East Mound', location: 'Konya, Turkey', year: 'c. 7500-5700 BCE' },
      { name: 'Building 77 (Shrine)', location: 'Catalhoyuk, Turkey', year: 'c. 6500 BCE' },
    ],
    influencedBy: ['ppnb'],
  ...
  },
  {
    ...
    iconicBuildings: [
      { name: 'Mehrgarh', location: 'Balochistan, Pakistan', year: 'c. 7000-2500 BCE' },
      { name: 'Rehman Dheri', location: 'Khyber Pakhtunkhwa, Pakistan', year: 'c. 3300 BCE' },
    ],
    influencedBy: ['ppnb'],
    influenced: [],
  ...
  },
  {
    ...
    iconicBuildings: [
      { name: 'Stonehenge', location: 'Wiltshire, England', year: 'c. 3000-2000 BCE' },
      { name: 'Newgrange', location: 'County Meath, Ireland', year: 'c. 3200 BCE' },
      { name: 'Carnac Stones', location: 'Brittany, France', year: 'c. 4500-3300 BCE' },
    ],
  ...
  // ==========================================================================
  {
    ...
    iconicBuildings: [
      { name: 'Bosco Verticale', location: 'Milan, Italy', year: '2014' },
      { name: 'Heydar Aliyev Center', location: 'Baku, Azerbaijan', year: '2012' },
      { name: 'CopenHill', location: 'Copenhagen, Denmark', year: '2019' },
    ],
