                    ...
                    <CardContent className="p-8">
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-grow">
                          ...
                          <p className="text-base font-semibold mb-4 text-[var(--muted-foreground)]">
                            {category.description}
                          </p>
                          <div className="flex items-center gap-6 text-sm font-bold text-[var(--muted-foreground)]">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-5xl font-black mb-2 text-[var(--primary)]">
                  {categories.reduce((sum: number, cat: any) => sum + cat._count.posts, 0)}
                </div>
                <div className="text-lg font-bold text-[var(--muted-foreground)]">
                  ROUND TABLES
                </div>
              </div>
              <div className="text-center">
